...
_TOUCHEVENTLIST = DESCRIPTOR.message_types_by_name['TouchEventList']
_TOUCHEVENT_TOUCHEVENTTYPE = _TOUCHEVENT.enum_types_by_name['TouchEventType']
TouchEvent = _reflection.GeneratedProtocolMessageType('TouchEvent', (_message.Message,), {
  'DESCRIPTOR' : _TOUCHEVENT,
  '__module__' : 'ubii.proto_baseline.dataStructure.touchEvent_pb2'
  # @@protoc_insertion_point(class_scope:ubii.proto_baseline.dataStructure.TouchEvent)
  })
...
TouchEventList = _reflection.GeneratedProtocolMessageType('TouchEventList', (_message.Message,), {
  ...
  '__module__' : 'ubii.proto_baseline.dataStructure.touchEvent_pb2'
  # @@protoc_insertion_point(class_scope:ubii.proto_baseline.dataStructure.TouchEventList)
  })
