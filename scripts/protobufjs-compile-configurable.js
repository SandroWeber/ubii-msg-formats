...
const inputDirectoryRelativePath = '/proto';
const outputRelativePath = '/proto/nrp-engine_msgs-protobufjs.js';
...
(function () {
  ...
  let generateCode = (protobufDirectory) => {
    let outputFile = path.resolve(__dirname + outputRelativePath);
  ...
  let protobufDirectory = path.normalize(__dirname + inputDirectoryRelativePath);
