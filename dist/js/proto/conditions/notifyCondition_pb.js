...
goog.exportSymbol('proto.ubii.conditions.NotifyCondition', null, global);
/**
...
proto.ubii.conditions.NotifyCondition.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    clientProfilePub: (f = msg.getClientProfilePub()) && proto_clients_client_pb.Client.toObject(includeInstance, f),
    clientProfileSub: (f = msg.getClientProfileSub()) && proto_clients_client_pb.Client.toObject(includeInstance, f)
  };
...
proto.ubii.conditions.NotifyCondition.prototype.getClientProfilePub = function() {
  return /** @type{?proto.ubii.clients.Client} */ (
    jspb.Message.getWrapperField(this, proto_clients_client_pb.Client, 4));
};
...
proto.ubii.conditions.NotifyCondition.prototype.getClientProfileSub = function() {
  return /** @type{?proto.ubii.clients.Client} */ (
    jspb.Message.getWrapperField(this, proto_clients_client_pb.Client, 5));
};
...
goog.object.extend(exports, proto.ubii.conditions);
