...
var proto_dataStructure_buttonEventType_pb = require('../../proto/dataStructure/buttonEventType_pb.js');
goog.object.extend(proto, proto_dataStructure_buttonEventType_pb);
...
proto.ubii.dataStructure.TouchEvent.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    position: (f = msg.getPosition()) && proto_dataStructure_vector2_pb.Vector2.toObject(includeInstance, f),
...
proto.ubii.dataStructure.TouchEvent.prototype.getPosition = function() {
  return /** @type{?proto.ubii.dataStructure.Vector2} */ (
    jspb.Message.getWrapperField(this, proto_dataStructure_vector2_pb.Vector2, 2));
};
