...
proto.ubii.dataStructure.Pose2D.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    direction: (f = msg.getDirection()) && proto_dataStructure_vector2_pb.Vector2.toObject(includeInstance, f),
...
proto.ubii.dataStructure.Pose2D.prototype.getPosition = function() {
  return /** @type{?proto.ubii.dataStructure.Vector2} */ (
    jspb.Message.getWrapperField(this, proto_dataStructure_vector2_pb.Vector2, 1));
};
