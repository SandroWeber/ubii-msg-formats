...
var proto_dataStructure_vector8_pb = require('../../proto/dataStructure/vector8_pb.js');
goog.object.extend(proto, proto_dataStructure_vector8_pb);
...
var proto_dataStructure_handGestureType_pb = require('../../proto/dataStructure/handGestureType_pb.js');
goog.object.extend(proto, proto_dataStructure_handGestureType_pb);
...
proto.ubii.dataStructure.MyoEvent.toObject = function(includeInstance, msg) {
  var f, obj = {
    emg: (f = msg.getEmg()) && proto_dataStructure_vector8_pb.Vector8.toObject(includeInstance, f),
    orientation: (f = msg.getOrientation()) && proto_dataStructure_quaternion_pb.Quaternion.toObject(includeInstance, f),
    gyroscope: (f = msg.getGyroscope()) && proto_dataStructure_vector3_pb.Vector3.toObject(includeInstance, f),
    accelerometer: (f = msg.getAccelerometer()) && proto_dataStructure_vector3_pb.Vector3.toObject(includeInstance, f),
...
proto.ubii.dataStructure.MyoEvent.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto_dataStructure_vector8_pb.Vector8;
      reader.readMessage(value,proto_dataStructure_vector8_pb.Vector8.deserializeBinaryFromReader);
      msg.setEmg(value);
      break;
    case 2:
...
proto.ubii.dataStructure.MyoEvent.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto_dataStructure_vector8_pb.Vector8.serializeBinaryToWriter
    );
  }
...
proto.ubii.dataStructure.MyoEvent.prototype.getEmg = function() {
  return /** @type{?proto.ubii.dataStructure.Vector8} */ (
    jspb.Message.getWrapperField(this, proto_dataStructure_vector8_pb.Vector8, 1));
};
...
proto.ubii.dataStructure.MyoEvent.prototype.getAccelerometer = function() {
  return /** @type{?proto.ubii.dataStructure.Vector3} */ (
    jspb.Message.getWrapperField(this, proto_dataStructure_vector3_pb.Vector3, 4));
};
