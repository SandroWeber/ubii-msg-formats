let constants = {
  DEFAULT_TOPICS: {
    SERVICES: {
      ...
      PM_REGISTRY_ADD: '/services/processing_module/registry/add_list',
      PM_REGISTRY_REMOVE: '/services/processing_module/registry/remove_list',
      ...
      NOTIFY_CONDITION_ADD: '/services/notify_condition/add',
      NOTIFY_CONDITION_REMOVE: '/services/notify_condition/remove',
      NOTIFY_CONDITION_GET_LIST: '/services/notify_condition/get_list',
  ...
  MSG_TYPES: {
    ...
    NOTIFY_CONDITION: 'ubii.conditions.NotifyCondition',
