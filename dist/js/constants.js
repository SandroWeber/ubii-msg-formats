let constants = { DEFAULT_TOPICS: 
   { SERVICES: 
      { SERVER_CONFIG: '/services/server_configuration',
        ...
        INTERACTION_LOCAL_DATABASE_GET_LIST: '/services/interaction/database/local/get_list',
        INTERACTION_ONLINE_DATABASE_GET_LIST: '/services/interaction/database/online/get_list',
