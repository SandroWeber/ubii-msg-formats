...
::google::protobuf::internal::SCCInfo<10> scc_info_ServiceReply =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 10, InitDefaultsServiceReply}, {
