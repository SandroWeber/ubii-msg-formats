...
class TopicSubscription PROTOBUF_FINAL :
 ...
 public:
  ...
  explicit constexpr TopicSubscription(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline void TopicSubscription::set_client_id(ArgT0&& arg0, ArgT... args) {
