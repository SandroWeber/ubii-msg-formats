...
class ServiceReply PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ubii.services.ServiceReply) */ {
 public:
  inline ServiceReply() : ServiceReply(nullptr) {}
  ~ServiceReply() override;
  explicit constexpr ServiceReply(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(ServiceReply* other) {
    if (other == this) return;
  ...
  protected:
  explicit ServiceReply(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  ...
  void unsafe_arena_set_allocated_success(
      ::ubii::general::Success* success);
  ::ubii::general::Success* unsafe_arena_release_success();
  ...
  void unsafe_arena_set_allocated_error(
      ::ubii::general::Error* error);
  ::ubii::general::Error* unsafe_arena_release_error();
  ...
  void unsafe_arena_set_allocated_client(
      ::ubii::clients::Client* client);
  ::ubii::clients::Client* unsafe_arena_release_client();
  ...
  void unsafe_arena_set_allocated_device(
      ::ubii::devices::Device* device);
  ::ubii::devices::Device* unsafe_arena_release_device();
  ...
  void unsafe_arena_set_allocated_server(
      ::ubii::servers::Server* server);
  ::ubii::servers::Server* unsafe_arena_release_server();
  ...
  void unsafe_arena_set_allocated_session_list(
      ::ubii::sessions::SessionList* session_list);
  ::ubii::sessions::SessionList* unsafe_arena_release_session_list();
  ...
  public:
  void unsafe_arena_set_allocated_processing_module(
      ::ubii::processing::ProcessingModule* processing_module);
  ::ubii::processing::ProcessingModule* unsafe_arena_release_processing_module();
  ...
  public:
  void unsafe_arena_set_allocated_topic_mux_list(
      ::ubii::devices::TopicMuxList* topic_mux_list);
  ::ubii::devices::TopicMuxList* unsafe_arena_release_topic_mux_list();
  ...
  public:
  void unsafe_arena_set_allocated_topic_demux_list(
      ::ubii::devices::TopicDemuxList* topic_demux_list);
  ::ubii::devices::TopicDemuxList* unsafe_arena_release_topic_demux_list();
  ...
  public:
  void unsafe_arena_set_allocated_client_list(
      ::ubii::clients::ClientList* client_list);
  ::ubii::clients::ClientList* unsafe_arena_release_client_list();
  ...
  void unsafe_arena_set_allocated_device_list(
      ::ubii::devices::DeviceList* device_list);
  ::ubii::devices::DeviceList* unsafe_arena_release_device_list();
  ...
  void unsafe_arena_set_allocated_service(
      ::ubii::services::Service* service);
  ::ubii::services::Service* unsafe_arena_release_service();
  ...
  void unsafe_arena_set_allocated_service_list(
      ::ubii::services::ServiceList* service_list);
  ::ubii::services::ServiceList* unsafe_arena_release_service_list();
  ...
  public:
  void unsafe_arena_set_allocated_lockstep_processing_reply(
      ::ubii::processing::LockstepProcessingReply* lockstep_processing_reply);
  ::ubii::processing::LockstepProcessingReply* unsafe_arena_release_lockstep_processing_reply();
...
inline ::ubii::general::Success* ServiceReply::unsafe_arena_release_success() {
  // @@protoc_insertion_point(field_unsafe_arena_release:ubii.services.ServiceReply.success)
  if (_internal_has_success()) {
    clear_has_type();
    ::ubii::general::Success* temp = type_.success_;
    type_.success_ = nullptr;
...
inline void ServiceReply::unsafe_arena_set_allocated_success(::ubii::general::Success* success) {
  clear_type();
  if (success) {
    set_has_success();
    type_.success_ = success;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ubii.services.ServiceReply.success)
}
inline ::ubii::general::Success* ServiceReply::_internal_mutable_success() {
  if (!_internal_has_success()) {
    clear_type();
    set_has_success();
    type_.success_ = CreateMaybeMessage< ::ubii::general::Success >(GetArena());
  }
...
inline ::ubii::general::Error* ServiceReply::unsafe_arena_release_error() {
  // @@protoc_insertion_point(field_unsafe_arena_release:ubii.services.ServiceReply.error)
  if (_internal_has_error()) {
    clear_has_type();
    ::ubii::general::Error* temp = type_.error_;
    type_.error_ = nullptr;
...
inline void ServiceReply::unsafe_arena_set_allocated_error(::ubii::general::Error* error) {
  clear_type();
  if (error) {
    set_has_error();
    type_.error_ = error;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ubii.services.ServiceReply.error)
}
inline ::ubii::general::Error* ServiceReply::_internal_mutable_error() {
  if (!_internal_has_error()) {
    clear_type();
    set_has_error();
    type_.error_ = CreateMaybeMessage< ::ubii::general::Error >(GetArena());
  }
  return type_.error_;
}
...
inline ::ubii::clients::Client* ServiceReply::unsafe_arena_release_client() {
  // @@protoc_insertion_point(field_unsafe_arena_release:ubii.services.ServiceReply.client)
  if (_internal_has_client()) {
    clear_has_type();
    ::ubii::clients::Client* temp = type_.client_;
    type_.client_ = nullptr;
...
inline void ServiceReply::unsafe_arena_set_allocated_client(::ubii::clients::Client* client) {
  clear_type();
  if (client) {
    set_has_client();
    type_.client_ = client;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ubii.services.ServiceReply.client)
}
inline ::ubii::clients::Client* ServiceReply::_internal_mutable_client() {
  if (!_internal_has_client()) {
    clear_type();
    set_has_client();
    type_.client_ = CreateMaybeMessage< ::ubii::clients::Client >(GetArena());
  }
...
inline ::ubii::devices::Device* ServiceReply::unsafe_arena_release_device() {
  // @@protoc_insertion_point(field_unsafe_arena_release:ubii.services.ServiceReply.device)
  if (_internal_has_device()) {
    clear_has_type();
    ::ubii::devices::Device* temp = type_.device_;
    type_.device_ = nullptr;
...
inline void ServiceReply::unsafe_arena_set_allocated_device(::ubii::devices::Device* device) {
  clear_type();
  if (device) {
    set_has_device();
    type_.device_ = device;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ubii.services.ServiceReply.device)
}
inline ::ubii::devices::Device* ServiceReply::_internal_mutable_device() {
  if (!_internal_has_device()) {
    clear_type();
    set_has_device();
    type_.device_ = CreateMaybeMessage< ::ubii::devices::Device >(GetArena());
  }
...
inline ::ubii::servers::Server* ServiceReply::unsafe_arena_release_server() {
  // @@protoc_insertion_point(field_unsafe_arena_release:ubii.services.ServiceReply.server)
  if (_internal_has_server()) {
    clear_has_type();
    ::ubii::servers::Server* temp = type_.server_;
    type_.server_ = nullptr;
...
inline void ServiceReply::unsafe_arena_set_allocated_server(::ubii::servers::Server* server) {
  clear_type();
  if (server) {
    set_has_server();
    type_.server_ = server;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ubii.services.ServiceReply.server)
}
inline ::ubii::servers::Server* ServiceReply::_internal_mutable_server() {
  if (!_internal_has_server()) {
    clear_type();
    set_has_server();
    type_.server_ = CreateMaybeMessage< ::ubii::servers::Server >(GetArena());
  }
...
inline ::ubii::sessions::Session* ServiceReply::unsafe_arena_release_session() {
  // @@protoc_insertion_point(field_unsafe_arena_release:ubii.services.ServiceReply.session)
  if (_internal_has_session()) {
    clear_has_type();
    ::ubii::sessions::Session* temp = type_.session_;
    type_.session_ = nullptr;
...
inline void ServiceReply::unsafe_arena_set_allocated_session(::ubii::sessions::Session* session) {
  clear_type();
  if (session) {
    set_has_session();
    type_.session_ = session;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ubii.services.ServiceReply.session)
}
...
inline ::ubii::sessions::SessionList* ServiceReply::unsafe_arena_release_session_list() {
  // @@protoc_insertion_point(field_unsafe_arena_release:ubii.services.ServiceReply.session_list)
  if (_internal_has_session_list()) {
    clear_has_type();
    ::ubii::sessions::SessionList* temp = type_.session_list_;
    type_.session_list_ = nullptr;
...
inline void ServiceReply::unsafe_arena_set_allocated_session_list(::ubii::sessions::SessionList* session_list) {
  clear_type();
  if (session_list) {
    set_has_session_list();
    type_.session_list_ = session_list;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ubii.services.ServiceReply.session_list)
}
inline ::ubii::sessions::SessionList* ServiceReply::_internal_mutable_session_list() {
  if (!_internal_has_session_list()) {
    clear_type();
    set_has_session_list();
    type_.session_list_ = CreateMaybeMessage< ::ubii::sessions::SessionList >(GetArena());
  }
...
inline ::ubii::processing::ProcessingModule* ServiceReply::unsafe_arena_release_processing_module() {
  // @@protoc_insertion_point(field_unsafe_arena_release:ubii.services.ServiceReply.processing_module)
  if (_internal_has_processing_module()) {
    clear_has_type();
    ::ubii::processing::ProcessingModule* temp = type_.processing_module_;
    type_.processing_module_ = nullptr;
...
inline void ServiceReply::unsafe_arena_set_allocated_processing_module(::ubii::processing::ProcessingModule* processing_module) {
  clear_type();
  if (processing_module) {
    set_has_processing_module();
    type_.processing_module_ = processing_module;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ubii.services.ServiceReply.processing_module)
}
inline ::ubii::processing::ProcessingModule* ServiceReply::_internal_mutable_processing_module() {
  if (!_internal_has_processing_module()) {
    clear_type();
    set_has_processing_module();
    type_.processing_module_ = CreateMaybeMessage< ::ubii::processing::ProcessingModule >(GetArena());
  }
...
inline ::ubii::processing::ProcessingModuleList* ServiceReply::unsafe_arena_release_processing_module_list() {
  // @@protoc_insertion_point(field_unsafe_arena_release:ubii.services.ServiceReply.processing_module_list)
  if (_internal_has_processing_module_list()) {
    clear_has_type();
    ::ubii::processing::ProcessingModuleList* temp = type_.processing_module_list_;
    type_.processing_module_list_ = nullptr;
...
inline void ServiceReply::unsafe_arena_set_allocated_processing_module_list(::ubii::processing::ProcessingModuleList* processing_module_list) {
  clear_type();
  if (processing_module_list) {
    set_has_processing_module_list();
    type_.processing_module_list_ = processing_module_list;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ubii.services.ServiceReply.processing_module_list)
}
...
inline ::ubii::dataStructure::StringList* ServiceReply::unsafe_arena_release_string_list() {
  // @@protoc_insertion_point(field_unsafe_arena_release:ubii.services.ServiceReply.string_list)
  if (_internal_has_string_list()) {
    clear_has_type();
    ::ubii::dataStructure::StringList* temp = type_.string_list_;
    type_.string_list_ = nullptr;
...
inline void ServiceReply::unsafe_arena_set_allocated_string_list(::ubii::dataStructure::StringList* string_list) {
  clear_type();
  if (string_list) {
    set_has_string_list();
    type_.string_list_ = string_list;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ubii.services.ServiceReply.string_list)
}
...
inline ::ubii::devices::TopicMux* ServiceReply::unsafe_arena_release_topic_mux() {
  // @@protoc_insertion_point(field_unsafe_arena_release:ubii.services.ServiceReply.topic_mux)
  if (_internal_has_topic_mux()) {
    clear_has_type();
    ::ubii::devices::TopicMux* temp = type_.topic_mux_;
    type_.topic_mux_ = nullptr;
...
inline void ServiceReply::unsafe_arena_set_allocated_topic_mux(::ubii::devices::TopicMux* topic_mux) {
  clear_type();
  if (topic_mux) {
    set_has_topic_mux();
    type_.topic_mux_ = topic_mux;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ubii.services.ServiceReply.topic_mux)
}
inline ::ubii::devices::TopicMux* ServiceReply::_internal_mutable_topic_mux() {
  if (!_internal_has_topic_mux()) {
    clear_type();
    set_has_topic_mux();
    type_.topic_mux_ = CreateMaybeMessage< ::ubii::devices::TopicMux >(GetArena());
  }
...
inline ::ubii::devices::TopicMuxList* ServiceReply::unsafe_arena_release_topic_mux_list() {
  // @@protoc_insertion_point(field_unsafe_arena_release:ubii.services.ServiceReply.topic_mux_list)
  if (_internal_has_topic_mux_list()) {
    clear_has_type();
    ::ubii::devices::TopicMuxList* temp = type_.topic_mux_list_;
    type_.topic_mux_list_ = nullptr;
...
inline void ServiceReply::unsafe_arena_set_allocated_topic_mux_list(::ubii::devices::TopicMuxList* topic_mux_list) {
  clear_type();
  if (topic_mux_list) {
    set_has_topic_mux_list();
    type_.topic_mux_list_ = topic_mux_list;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ubii.services.ServiceReply.topic_mux_list)
}
inline ::ubii::devices::TopicMuxList* ServiceReply::_internal_mutable_topic_mux_list() {
  if (!_internal_has_topic_mux_list()) {
    clear_type();
    set_has_topic_mux_list();
    type_.topic_mux_list_ = CreateMaybeMessage< ::ubii::devices::TopicMuxList >(GetArena());
  }
...
inline ::ubii::devices::TopicDemux* ServiceReply::unsafe_arena_release_topic_demux() {
  // @@protoc_insertion_point(field_unsafe_arena_release:ubii.services.ServiceReply.topic_demux)
  if (_internal_has_topic_demux()) {
    clear_has_type();
    ::ubii::devices::TopicDemux* temp = type_.topic_demux_;
    type_.topic_demux_ = nullptr;
...
inline void ServiceReply::unsafe_arena_set_allocated_topic_demux(::ubii::devices::TopicDemux* topic_demux) {
  clear_type();
  if (topic_demux) {
    set_has_topic_demux();
    type_.topic_demux_ = topic_demux;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ubii.services.ServiceReply.topic_demux)
}
inline ::ubii::devices::TopicDemux* ServiceReply::_internal_mutable_topic_demux() {
  if (!_internal_has_topic_demux()) {
    clear_type();
    set_has_topic_demux();
    type_.topic_demux_ = CreateMaybeMessage< ::ubii::devices::TopicDemux >(GetArena());
  }
...
inline ::ubii::devices::TopicDemuxList* ServiceReply::unsafe_arena_release_topic_demux_list() {
  // @@protoc_insertion_point(field_unsafe_arena_release:ubii.services.ServiceReply.topic_demux_list)
  if (_internal_has_topic_demux_list()) {
    clear_has_type();
    ::ubii::devices::TopicDemuxList* temp = type_.topic_demux_list_;
    type_.topic_demux_list_ = nullptr;
...
inline void ServiceReply::unsafe_arena_set_allocated_topic_demux_list(::ubii::devices::TopicDemuxList* topic_demux_list) {
  clear_type();
  if (topic_demux_list) {
    set_has_topic_demux_list();
    type_.topic_demux_list_ = topic_demux_list;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ubii.services.ServiceReply.topic_demux_list)
}
inline ::ubii::devices::TopicDemuxList* ServiceReply::_internal_mutable_topic_demux_list() {
  if (!_internal_has_topic_demux_list()) {
    clear_type();
    set_has_topic_demux_list();
    type_.topic_demux_list_ = CreateMaybeMessage< ::ubii::devices::TopicDemuxList >(GetArena());
  }
...
inline ::ubii::clients::ClientList* ServiceReply::unsafe_arena_release_client_list() {
  // @@protoc_insertion_point(field_unsafe_arena_release:ubii.services.ServiceReply.client_list)
  if (_internal_has_client_list()) {
    clear_has_type();
    ::ubii::clients::ClientList* temp = type_.client_list_;
    type_.client_list_ = nullptr;
...
inline void ServiceReply::unsafe_arena_set_allocated_client_list(::ubii::clients::ClientList* client_list) {
  clear_type();
  if (client_list) {
    set_has_client_list();
    type_.client_list_ = client_list;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ubii.services.ServiceReply.client_list)
}
inline ::ubii::clients::ClientList* ServiceReply::_internal_mutable_client_list() {
  if (!_internal_has_client_list()) {
    clear_type();
    set_has_client_list();
    type_.client_list_ = CreateMaybeMessage< ::ubii::clients::ClientList >(GetArena());
  }
...
inline ::ubii::devices::DeviceList* ServiceReply::unsafe_arena_release_device_list() {
  // @@protoc_insertion_point(field_unsafe_arena_release:ubii.services.ServiceReply.device_list)
  if (_internal_has_device_list()) {
    clear_has_type();
    ::ubii::devices::DeviceList* temp = type_.device_list_;
    type_.device_list_ = nullptr;
...
inline void ServiceReply::unsafe_arena_set_allocated_device_list(::ubii::devices::DeviceList* device_list) {
  clear_type();
  if (device_list) {
    set_has_device_list();
    type_.device_list_ = device_list;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ubii.services.ServiceReply.device_list)
}
inline ::ubii::devices::DeviceList* ServiceReply::_internal_mutable_device_list() {
  if (!_internal_has_device_list()) {
    clear_type();
    set_has_device_list();
    type_.device_list_ = CreateMaybeMessage< ::ubii::devices::DeviceList >(GetArena());
  }
...
inline ::ubii::services::Service* ServiceReply::unsafe_arena_release_service() {
  // @@protoc_insertion_point(field_unsafe_arena_release:ubii.services.ServiceReply.service)
  if (_internal_has_service()) {
    clear_has_type();
    ::ubii::services::Service* temp = type_.service_;
    type_.service_ = nullptr;
...
inline void ServiceReply::unsafe_arena_set_allocated_service(::ubii::services::Service* service) {
  clear_type();
  if (service) {
    set_has_service();
    type_.service_ = service;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ubii.services.ServiceReply.service)
}
inline ::ubii::services::Service* ServiceReply::_internal_mutable_service() {
  if (!_internal_has_service()) {
    clear_type();
    set_has_service();
    type_.service_ = CreateMaybeMessage< ::ubii::services::Service >(GetArena());
  }
...
inline ::ubii::services::ServiceList* ServiceReply::unsafe_arena_release_service_list() {
  // @@protoc_insertion_point(field_unsafe_arena_release:ubii.services.ServiceReply.service_list)
  if (_internal_has_service_list()) {
    clear_has_type();
    ::ubii::services::ServiceList* temp = type_.service_list_;
    type_.service_list_ = nullptr;
...
inline void ServiceReply::unsafe_arena_set_allocated_service_list(::ubii::services::ServiceList* service_list) {
  clear_type();
  if (service_list) {
    set_has_service_list();
    type_.service_list_ = service_list;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ubii.services.ServiceReply.service_list)
}
inline ::ubii::services::ServiceList* ServiceReply::_internal_mutable_service_list() {
  if (!_internal_has_service_list()) {
    clear_type();
    set_has_service_list();
    type_.service_list_ = CreateMaybeMessage< ::ubii::services::ServiceList >(GetArena());
  }
...
inline ::ubii::processing::LockstepProcessingReply* ServiceReply::unsafe_arena_release_lockstep_processing_reply() {
  // @@protoc_insertion_point(field_unsafe_arena_release:ubii.services.ServiceReply.lockstep_processing_reply)
  if (_internal_has_lockstep_processing_reply()) {
    clear_has_type();
    ::ubii::processing::LockstepProcessingReply* temp = type_.lockstep_processing_reply_;
    type_.lockstep_processing_reply_ = nullptr;
...
inline void ServiceReply::unsafe_arena_set_allocated_lockstep_processing_reply(::ubii::processing::LockstepProcessingReply* lockstep_processing_reply) {
  clear_type();
  if (lockstep_processing_reply) {
    set_has_lockstep_processing_reply();
    type_.lockstep_processing_reply_ = lockstep_processing_reply;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ubii.services.ServiceReply.lockstep_processing_reply)
}
inline ::ubii::processing::LockstepProcessingReply* ServiceReply::_internal_mutable_lockstep_processing_reply() {
  if (!_internal_has_lockstep_processing_reply()) {
    clear_type();
    set_has_lockstep_processing_reply();
    type_.lockstep_processing_reply_ = CreateMaybeMessage< ::ubii::processing::LockstepProcessingReply >(GetArena());
  }
