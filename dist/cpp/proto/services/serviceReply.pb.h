...
class ServiceReply :
 ...
 public:
  ...
  enum TypeCase {
    ...
    kService = 17,
    kServiceList = 18,
    kProcessingModule = 19,
    kProcessingModuleList = 20,
    kLockstepProcessingReply = 21,
    TYPE_NOT_SET = 0,
  };
  ...
  enum : int {
    ...
    kProcessingModuleFieldNumber = 19,
    kProcessingModuleListFieldNumber = 20,
    kLockstepProcessingReplyFieldNumber = 21,
  };
