...
inline bool Component_IOType_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, Component_IOType* value) {
...
class Component PROTOBUF_FINAL :
 ...
 public:
  ...
  static inline bool IOType_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name,
      IOType* value) {
...
class ComponentList PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ubii.devices.ComponentList) */ {
 public:
  inline ComponentList() : ComponentList(nullptr) {}
  ~ComponentList() override;
  explicit constexpr ComponentList(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(ComponentList* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  protected:
  explicit ComponentList(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
...
inline void Component::set_topic(ArgT0&& arg0, ArgT... args) {
...
template <typename ArgT0, typename... ArgT>
PROTOBUF_ALWAYS_INLINE
inline void Component::set_message_format(ArgT0&& arg0, ArgT... args) {
...
template <typename ArgT0, typename... ArgT>
PROTOBUF_ALWAYS_INLINE
inline void Component::set_device_id(ArgT0&& arg0, ArgT... args) {
 
 device_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArena());
...
template <typename ArgT0, typename... ArgT>
PROTOBUF_ALWAYS_INLINE
inline void Component::set_description(ArgT0&& arg0, ArgT... args) {
...
template <typename ArgT0, typename... ArgT>
PROTOBUF_ALWAYS_INLINE
inline void Component::set_id(ArgT0&& arg0, ArgT... args) {
...
template <typename ArgT0, typename... ArgT>
PROTOBUF_ALWAYS_INLINE
inline void Component::set_name(ArgT0&& arg0, ArgT... args) {
