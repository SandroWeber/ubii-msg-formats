...
#ifndef PROTOBUF_proto_2fdevices_2fcomponent_2eproto__INCLUDED
#define PROTOBUF_proto_2fdevices_2fcomponent_2eproto__INCLUDED
...
class Component : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ubii.devices.Component) */ {
 ...
 private:
  ...
  friend void  protobuf_AddDesc_proto_2fdevices_2fcomponent_2eproto();
  friend void protobuf_AssignDesc_proto_2fdevices_2fcomponent_2eproto();
  friend void protobuf_ShutdownFile_proto_2fdevices_2fcomponent_2eproto();
...
class ComponentList : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ubii.devices.ComponentList) */ {
 public:
  ...
  inline ComponentList* New() const { return New(NULL); }

  ComponentList* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static ComponentList* default_instance_;
};
// ===================================================================
...
template <> struct is_proto_enum< ::ubii::devices::Component_IOType> : ::google::protobuf::internal::true_type {};
template <>
...
#endif  // PROTOBUF_proto_2fdevices_2fcomponent_2eproto__INCLUDED
