...
inline void TopicMux::set_topic_selector(const char* value) {
  ...
  topic_selector_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:ubii.devices.TopicMux.topic_selector)
}
inline void TopicMux::set_topic_selector(const char* value,
    size_t size) {
  
  topic_selector_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline void TopicMux::set_identity_match_pattern(const char* value) {
  ...
  identity_match_pattern_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:ubii.devices.TopicMux.identity_match_pattern)
}
inline void TopicMux::set_identity_match_pattern(const char* value,
    size_t size) {
  
  identity_match_pattern_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
