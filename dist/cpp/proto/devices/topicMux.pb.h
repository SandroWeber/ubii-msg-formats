...
class TopicMux PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ubii.devices.TopicMux) */ {
 public:
  inline TopicMux() : TopicMux(nullptr) {}
  ~TopicMux() override;
  explicit constexpr TopicMux(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(TopicMux* other) {
    if (other == this) return;
  ...
  protected:
  explicit TopicMux(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_topic_selector(ArgT0&& arg0, ArgT... args);
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_identity_match_pattern(ArgT0&& arg0, ArgT... args);
...
class TopicMuxList PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ubii.devices.TopicMuxList) */ {
 public:
  inline TopicMuxList() : TopicMuxList(nullptr) {}
  ~TopicMuxList() override;
  explicit constexpr TopicMuxList(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(TopicMuxList* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  protected:
  explicit TopicMuxList(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
...
inline void TopicMux::set_id(ArgT0&& arg0, ArgT... args) {
...
template <typename ArgT0, typename... ArgT>
PROTOBUF_ALWAYS_INLINE
inline void TopicMux::set_name(ArgT0&& arg0, ArgT... args) {
...
template <typename ArgT0, typename... ArgT>
PROTOBUF_ALWAYS_INLINE
inline void TopicMux::set_data_type(ArgT0&& arg0, ArgT... args) {
...
template <typename ArgT0, typename... ArgT>
PROTOBUF_ALWAYS_INLINE
inline void TopicMux::set_topic_selector(ArgT0&& arg0, ArgT... args) {
 
 topic_selector_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArena());
...
inline const std::string& TopicMux::_internal_topic_selector() const {
  return topic_selector_.Get();
}
inline void TopicMux::_internal_set_topic_selector(const std::string& value) {
  
  topic_selector_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline std::string* TopicMux::_internal_mutable_topic_selector() {
  
  return topic_selector_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* TopicMux::release_topic_selector() {
  ...
  return topic_selector_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void TopicMux::set_allocated_topic_selector(std::string* topic_selector) {
  ...
  topic_selector_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), topic_selector,
      GetArena());
...
template <typename ArgT0, typename... ArgT>
PROTOBUF_ALWAYS_INLINE
inline void TopicMux::set_identity_match_pattern(ArgT0&& arg0, ArgT... args) {
 
 identity_match_pattern_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArena());
...
inline const std::string& TopicMux::_internal_identity_match_pattern() const {
  return identity_match_pattern_.Get();
}
inline void TopicMux::_internal_set_identity_match_pattern(const std::string& value) {
  
  identity_match_pattern_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline std::string* TopicMux::_internal_mutable_identity_match_pattern() {
  
  return identity_match_pattern_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* TopicMux::release_identity_match_pattern() {
  ...
  return identity_match_pattern_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void TopicMux::set_allocated_identity_match_pattern(std::string* identity_match_pattern) {
  ...
  identity_match_pattern_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), identity_match_pattern,
      GetArena());
