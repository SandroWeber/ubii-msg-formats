...
inline void TopicDemux::set_output_topic_format(const char* value) {
  ...
  output_topic_format_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:ubii.devices.TopicDemux.output_topic_format)
}
inline void TopicDemux::set_output_topic_format(const char* value,
    size_t size) {
  
  output_topic_format_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
