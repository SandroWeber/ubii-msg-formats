...
class LockstepProcessingRequest PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ubii.processing.LockstepProcessingRequest) */ {
 public:
  inline LockstepProcessingRequest() : LockstepProcessingRequest(nullptr) {}
  ~LockstepProcessingRequest() override;
  explicit constexpr LockstepProcessingRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(LockstepProcessingRequest* other) {
    if (other == this) return;
  ...
  protected:
  explicit LockstepProcessingRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
...
class LockstepProcessingReply PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ubii.processing.LockstepProcessingReply) */ {
 public:
  inline LockstepProcessingReply() : LockstepProcessingReply(nullptr) {}
  ~LockstepProcessingReply() override;
  explicit constexpr LockstepProcessingReply(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(LockstepProcessingReply* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  protected:
  explicit LockstepProcessingReply(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
