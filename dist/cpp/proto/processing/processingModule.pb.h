...
class ProcessingMode_Free :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ubii.processing.ProcessingMode.Free) */ {
 public:
  ProcessingMode_Free();
  ...
  inline void Swap(ProcessingMode_Free* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline ProcessingMode_Free* New() const final {
    return CreateMaybeMessage<ProcessingMode_Free>(nullptr);
  }

  ProcessingMode_Free* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "ubii.processing.ProcessingMode.Free";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
...
class ProcessingMode :
 ...
 public:
  ...
  ::ubii::processing::ProcessingMode_Free* _internal_mutable_free();
  public:
...
class ModuleIO :
 ...
 public:
  ...
  private:
  bool _internal_is_record_list() const;
  void _internal_set_is_record_list(bool value);
  public:
...
// .ubii.processing.ProcessingMode.Free free = 4;
inline bool ProcessingMode::_internal_has_free() const {
...
inline ::ubii::processing::ProcessingMode_Free* ProcessingMode::_internal_mutable_free() {
  if (!_internal_has_free()) {
    clear_mode();
    set_has_free();
...
inline bool ModuleIO::_internal_is_record_list() const {
...
inline bool ModuleIO::is_record_list() const {
  ...
  return _internal_is_record_list();
}
inline void ModuleIO::_internal_set_is_record_list(bool value) {
  
  is_record_list_ = value;
}
inline void ModuleIO::set_is_record_list(bool value) {
  _internal_set_is_record_list(value);
