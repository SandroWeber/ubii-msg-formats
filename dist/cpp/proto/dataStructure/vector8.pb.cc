...
extern PROTOBUF_INTERNAL_EXPORT_proto_2fdataStructure_2fvector8_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Vector8_proto_2fdataStructure_2fvector8_2eproto;
namespace ubii {
...
class Vector8ListDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<Vector8List> _instance;
} _Vector8List_default_instance_;
}  // namespace dataStructure
}  // namespace ubii
static void InitDefaultsscc_info_Vector8_proto_2fdataStructure_2fvector8_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Vector8_proto_2fdataStructure_2fvector8_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_Vector8_proto_2fdataStructure_2fvector8_2eproto}, {}};

static void InitDefaultsscc_info_Vector8List_proto_2fdataStructure_2fvector8_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_Vector8List_proto_2fdataStructure_2fvector8_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_Vector8List_proto_2fdataStructure_2fvector8_2eproto}, {
      &scc_info_Vector8_proto_2fdataStructure_2fvector8_2eproto.base,}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_proto_2fdataStructure_2fvector8_2eproto[2];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_proto_2fdataStructure_2fvector8_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_proto_2fdataStructure_2fvector8_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_proto_2fdataStructure_2fvector8_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::ubii::dataStructure::Vector8List, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::ubii::dataStructure::Vector8List, elements_),
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::ubii::dataStructure::_Vector8List_default_instance_),
};

const char descriptor_table_protodef_proto_2fdataStructure_2fvector8_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_proto_2fdataStructure_2fvector8_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_proto_2fdataStructure_2fvector8_2eproto_sccs[2] = {
  &scc_info_Vector8_proto_2fdataStructure_2fvector8_2eproto.base,
  &scc_info_Vector8List_proto_2fdataStructure_2fvector8_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_proto_2fdataStructure_2fvector8_2eproto_once;
static bool descriptor_table_proto_2fdataStructure_2fvector8_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_proto_2fdataStructure_2fvector8_2eproto = {
  &descriptor_table_proto_2fdataStructure_2fvector8_2eproto_initialized, descriptor_table_protodef_proto_2fdataStructure_2fvector8_2eproto, "proto/dataStructure/vector8.proto", 232,
  &descriptor_table_proto_2fdataStructure_2fvector8_2eproto_once, descriptor_table_proto_2fdataStructure_2fvector8_2eproto_sccs, descriptor_table_proto_2fdataStructure_2fvector8_2eproto_deps, 2, 0,
  schemas, file_default_instances, TableStruct_proto_2fdataStructure_2fvector8_2eproto::offsets,
  file_level_metadata_proto_2fdataStructure_2fvector8_2eproto, 2, file_level_enum_descriptors_proto_2fdataStructure_2fvector8_2eproto, file_level_service_descriptors_proto_2fdataStructure_2fvector8_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_proto_2fdataStructure_2fvector8_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_proto_2fdataStructure_2fvector8_2eproto), true);
namespace ubii {
namespace dataStructure {
...
const Vector8& Vector8::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_Vector8_proto_2fdataStructure_2fvector8_2eproto.base);
...
::PROTOBUF_NAMESPACE_ID::uint8* Vector8::_InternalSerialize(
...
void Vector8List::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_Vector8List_proto_2fdataStructure_2fvector8_2eproto.base);
}
...
const char* Vector8List::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
...
::PROTOBUF_NAMESPACE_ID::uint8* Vector8List::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
...
void Vector8List::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:ubii.dataStructure.Vector8List)
  GOOGLE_DCHECK_NE(&from, this);
  const Vector8List* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<Vector8List>(
          &from);
  if (source == nullptr) {
...
void Vector8List::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
...
::PROTOBUF_NAMESPACE_ID::Metadata Vector8List::GetMetadata() const {
  return GetMetadataStatic();
}
...
template<> PROTOBUF_NOINLINE ::ubii::dataStructure::Vector8List* Arena::CreateMaybeMessage< ::ubii::dataStructure::Vector8List >(Arena* arena) {
