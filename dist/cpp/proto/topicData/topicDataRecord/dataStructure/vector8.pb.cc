...
struct Vector8DefaultTypeInternal {
  constexpr Vector8DefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
  ~Vector8DefaultTypeInternal() {}
  union {
    Vector8 _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT Vector8DefaultTypeInternal _Vector8_default_instance_;
}  // namespace dataStructure
}  // namespace ubii
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_proto_2ftopicData_2ftopicDataRecord_2fdataStructure_2fvector8_2eproto = {
  false, false, 196, descriptor_table_protodef_proto_2ftopicData_2ftopicDataRecord_2fdataStructure_2fvector8_2eproto, "proto/topicData/topicDataRecord/dataStructure/vector8.proto", 
  &descriptor_table_proto_2ftopicData_2ftopicDataRecord_2fdataStructure_2fvector8_2eproto_once, nullptr, 0, 1,
  schemas, file_default_instances, TableStruct_proto_2ftopicData_2ftopicDataRecord_2fdataStructure_2fvector8_2eproto::offsets,
  file_level_metadata_proto_2ftopicData_2ftopicDataRecord_2fdataStructure_2fvector8_2eproto, file_level_enum_descriptors_proto_2ftopicData_2ftopicDataRecord_2fdataStructure_2fvector8_2eproto, file_level_service_descriptors_proto_2ftopicData_2ftopicDataRecord_2fdataStructure_2fvector8_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_proto_2ftopicData_2ftopicDataRecord_2fdataStructure_2fvector8_2eproto_getter() {
  return &descriptor_table_proto_2ftopicData_2ftopicDataRecord_2fdataStructure_2fvector8_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_proto_2ftopicData_2ftopicDataRecord_2fdataStructure_2fvector8_2eproto(&descriptor_table_proto_2ftopicData_2ftopicDataRecord_2fdataStructure_2fvector8_2eproto);
namespace ubii {
namespace dataStructure {
...
Vector8::Vector8(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena) {
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:ubii.dataStructure.Vector8)
}
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&v7_) -
    reinterpret_cast<char*>(&v0_)) + sizeof(v7_));
}
...
void Vector8::ArenaDtor(void* object) {
  Vector8* _this = reinterpret_cast< Vector8* >(object);
  (void)_this;
}
void Vector8::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
void Vector8::InternalSwap(Vector8* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Vector8, v7_)
      + sizeof(Vector8::v7_)
      - PROTOBUF_FIELD_OFFSET(Vector8, v0_)>(
...
::PROTOBUF_NAMESPACE_ID::Metadata Vector8::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_proto_2ftopicData_2ftopicDataRecord_2fdataStructure_2fvector8_2eproto_getter, &descriptor_table_proto_2ftopicData_2ftopicDataRecord_2fdataStructure_2fvector8_2eproto_once,
      file_level_metadata_proto_2ftopicData_2ftopicDataRecord_2fdataStructure_2fvector8_2eproto[0]);
}
...
template<> PROTOBUF_NOINLINE ::ubii::dataStructure::Vector8* Arena::CreateMaybeMessage< ::ubii::dataStructure::Vector8 >(Arena* arena) {
  return Arena::CreateMessageInternal< ::ubii::dataStructure::Vector8 >(arena);
}
