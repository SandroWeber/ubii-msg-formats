...
#ifndef GOOGLE_PROTOBUF_INCLUDED_proto_2ftopicData_2ftopicDataRecord_2fdataStructure_2fimage_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_proto_2ftopicData_2ftopicDataRecord_2fdataStructure_2fimage_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_proto_2ftopicData_2ftopicDataRecord_2fdataStructure_2fimage_2eproto
...
struct TableStruct_proto_2ftopicData_2ftopicDataRecord_2fdataStructure_2fimage_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_proto_2ftopicData_2ftopicDataRecord_2fdataStructure_2fimage_2eproto;
namespace ubii {
...
class Image2D PROTOBUF_FINAL :
 ...
 public:
  ...
  void UnsafeArenaSwap(Image2D* other) {
    if (other == this) return;
  ...
  protected:
  explicit Image2D(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  ...
  static inline bool DataFormat_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name,
      DataFormat* value) {
 ...
 private:
  ...
  friend struct ::TableStruct_proto_2ftopicData_2ftopicDataRecord_2fdataStructure_2fimage_2eproto;
};
// -------------------------------------------------------------------

class Image2DList PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ubii.dataStructure.Image2DList) */ {
 public:
  inline Image2DList() : Image2DList(nullptr) {}
  ~Image2DList() override;
  explicit constexpr Image2DList(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(Image2DList* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  protected:
  explicit Image2DList(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
...
inline void Image2D::set_data(ArgT0&& arg0, ArgT... args) {
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_proto_2ftopicData_2ftopicDataRecord_2fdataStructure_2fimage_2eproto
