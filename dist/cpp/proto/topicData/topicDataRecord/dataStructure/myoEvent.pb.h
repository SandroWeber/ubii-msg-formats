...
#ifndef GOOGLE_PROTOBUF_INCLUDED_proto_2ftopicData_2ftopicDataRecord_2fdataStructure_2fmyoEvent_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_proto_2ftopicData_2ftopicDataRecord_2fdataStructure_2fmyoEvent_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_proto_2ftopicData_2ftopicDataRecord_2fdataStructure_2fmyoEvent_2eproto
...
struct TableStruct_proto_2ftopicData_2ftopicDataRecord_2fdataStructure_2fmyoEvent_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_proto_2ftopicData_2ftopicDataRecord_2fdataStructure_2fmyoEvent_2eproto;
namespace ubii {
...
class MyoEvent PROTOBUF_FINAL :
 ...
 public:
  ...
  void UnsafeArenaSwap(MyoEvent* other) {
    if (other == this) return;
  ...
  protected:
  explicit MyoEvent(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_proto_2ftopicData_2ftopicDataRecord_2fdataStructure_2fmyoEvent_2eproto);
    return ::descriptor_table_proto_2ftopicData_2ftopicDataRecord_2fdataStructure_2fmyoEvent_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  public:
  void unsafe_arena_set_allocated_emg(
      ::ubii::dataStructure::Vector8* emg);
  ::ubii::dataStructure::Vector8* unsafe_arena_release_emg();
  ...
  void unsafe_arena_set_allocated_orientation(
      ::ubii::dataStructure::Quaternion* orientation);
  ::ubii::dataStructure::Quaternion* unsafe_arena_release_orientation();
  ...
  void unsafe_arena_set_allocated_gyroscope(
      ::ubii::dataStructure::Vector3* gyroscope);
  ::ubii::dataStructure::Vector3* unsafe_arena_release_gyroscope();
  ...
  void unsafe_arena_set_allocated_accelerometer(
      ::ubii::dataStructure::Vector3* accelerometer);
  ::ubii::dataStructure::Vector3* unsafe_arena_release_accelerometer();
 ...
 private:
  ...
  friend struct ::TableStruct_proto_2ftopicData_2ftopicDataRecord_2fdataStructure_2fmyoEvent_2eproto;
};
// ===================================================================
...
inline void MyoEvent::unsafe_arena_set_allocated_emg(
    ::ubii::dataStructure::Vector8* emg) {
  if (GetArena() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ubii.dataStructure.MyoEvent.emg)
}
...
inline ::ubii::dataStructure::Vector8* MyoEvent::unsafe_arena_release_emg() {
...
inline ::ubii::dataStructure::Vector8* MyoEvent::_internal_mutable_emg() {
  ...
  if (emg_ == nullptr) {
    auto* p = CreateMaybeMessage<::ubii::dataStructure::Vector8>(GetArena());
    emg_ = p;
  }
  return emg_;
}
...
inline void MyoEvent::set_allocated_emg(::ubii::dataStructure::Vector8* emg) {
  ...
  if (emg) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(emg)->GetArena();
...
inline void MyoEvent::unsafe_arena_set_allocated_orientation(
    ::ubii::dataStructure::Quaternion* orientation) {
  if (GetArena() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ubii.dataStructure.MyoEvent.orientation)
}
...
inline ::ubii::dataStructure::Quaternion* MyoEvent::unsafe_arena_release_orientation() {
...
inline ::ubii::dataStructure::Quaternion* MyoEvent::_internal_mutable_orientation() {
  ...
  if (orientation_ == nullptr) {
    auto* p = CreateMaybeMessage<::ubii::dataStructure::Quaternion>(GetArena());
    orientation_ = p;
  }
  return orientation_;
}
...
inline void MyoEvent::unsafe_arena_set_allocated_gyroscope(
    ::ubii::dataStructure::Vector3* gyroscope) {
  if (GetArena() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ubii.dataStructure.MyoEvent.gyroscope)
}
...
inline ::ubii::dataStructure::Vector3* MyoEvent::unsafe_arena_release_gyroscope() {
...
inline void MyoEvent::set_allocated_gyroscope(::ubii::dataStructure::Vector3* gyroscope) {
  ...
  if (gyroscope) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(gyroscope)->GetArena();
    if (message_arena != submessage_arena) {
...
inline void MyoEvent::unsafe_arena_set_allocated_accelerometer(
    ::ubii::dataStructure::Vector3* accelerometer) {
  if (GetArena() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ubii.dataStructure.MyoEvent.accelerometer)
}
...
inline ::ubii::dataStructure::Vector3* MyoEvent::unsafe_arena_release_accelerometer() {
...
inline void MyoEvent::set_allocated_accelerometer(::ubii::dataStructure::Vector3* accelerometer) {
  ...
  if (accelerometer) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(accelerometer)->GetArena();
    if (message_arena != submessage_arena) {
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_proto_2ftopicData_2ftopicDataRecord_2fdataStructure_2fmyoEvent_2eproto
