...
inline bool TouchEvent_TouchEventType_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, TouchEvent_TouchEventType* value) {
...
class TouchEvent PROTOBUF_FINAL :
 ...
 public:
  ...
  static inline bool TouchEventType_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name,
...
class TouchEventList PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ubii.dataStructure.TouchEventList) */ {
 public:
  inline TouchEventList() : TouchEventList(nullptr) {}
  ~TouchEventList() override;
  explicit constexpr TouchEventList(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(TouchEventList* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  protected:
  explicit TouchEventList(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
...
inline void TouchEvent::unsafe_arena_set_allocated_position(
    ::ubii::dataStructure::Vector2* position) {
  if (GetArena() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ubii.dataStructure.TouchEvent.position)
}
...
inline ::ubii::dataStructure::Vector2* TouchEvent::unsafe_arena_release_position() {
...
inline void TouchEvent::set_id(ArgT0&& arg0, ArgT... args) {
