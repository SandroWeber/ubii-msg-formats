...
class Pose3D PROTOBUF_FINAL :
 ...
 public:
  ...
  void unsafe_arena_set_allocated_position(
      ::ubii::dataStructure::Vector3* position);
  ::ubii::dataStructure::Vector3* unsafe_arena_release_position();
  ...
  void unsafe_arena_set_allocated_euler(
      ::ubii::dataStructure::Vector3* euler);
  ::ubii::dataStructure::Vector3* unsafe_arena_release_euler();
...
inline void Pose3D::unsafe_arena_set_allocated_position(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ubii.dataStructure.Pose3D.position)
}
...
inline ::ubii::dataStructure::Vector3* Pose3D::unsafe_arena_release_position() {
...
inline ::ubii::dataStructure::Quaternion* Pose3D::unsafe_arena_release_quaternion() {
  // @@protoc_insertion_point(field_unsafe_arena_release:ubii.dataStructure.Pose3D.quaternion)
  if (_internal_has_quaternion()) {
    clear_has_orientation();
    ::ubii::dataStructure::Quaternion* temp = orientation_.quaternion_;
    orientation_.quaternion_ = nullptr;
...
inline void Pose3D::unsafe_arena_set_allocated_quaternion(::ubii::dataStructure::Quaternion* quaternion) {
  clear_orientation();
  if (quaternion) {
    set_has_quaternion();
    orientation_.quaternion_ = quaternion;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ubii.dataStructure.Pose3D.quaternion)
}
inline ::ubii::dataStructure::Quaternion* Pose3D::_internal_mutable_quaternion() {
  if (!_internal_has_quaternion()) {
    clear_orientation();
    set_has_quaternion();
    orientation_.quaternion_ = CreateMaybeMessage< ::ubii::dataStructure::Quaternion >(GetArena());
  }
...
inline ::ubii::dataStructure::Vector3* Pose3D::unsafe_arena_release_euler() {
  // @@protoc_insertion_point(field_unsafe_arena_release:ubii.dataStructure.Pose3D.euler)
  if (_internal_has_euler()) {
    clear_has_orientation();
    ::ubii::dataStructure::Vector3* temp = orientation_.euler_;
    orientation_.euler_ = nullptr;
...
inline void Pose3D::unsafe_arena_set_allocated_euler(::ubii::dataStructure::Vector3* euler) {
  clear_orientation();
  if (euler) {
    set_has_euler();
    orientation_.euler_ = euler;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ubii.dataStructure.Pose3D.euler)
}
inline ::ubii::dataStructure::Vector3* Pose3D::_internal_mutable_euler() {
  if (!_internal_has_euler()) {
    clear_orientation();
    set_has_euler();
    orientation_.euler_ = CreateMaybeMessage< ::ubii::dataStructure::Vector3 >(GetArena());
  }
