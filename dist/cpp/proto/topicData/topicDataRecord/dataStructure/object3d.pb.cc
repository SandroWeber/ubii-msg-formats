...
::google::protobuf::internal::SCCInfo<1> scc_info_Object3D =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsObject3D}, {
...
void Object3D::InitAsDefaultInstance() {
  ::ubii::dataStructure::_Object3D_default_instance_._instance.get_mutable()->pose_ = const_cast< ::ubii::dataStructure::Pose*>(
...
Object3D::Object3D(const Object3D& from)
  ...
  if (from.has_pose()) {
    pose_ = new ::ubii::dataStructure::Pose(*from.pose_);
  } else {
    pose_ = NULL;
  }
