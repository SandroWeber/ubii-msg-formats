...
class TopicData PROTOBUF_FINAL :
 ...
 public:
  ...
  ~TopicData() override;
  explicit constexpr TopicData(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  protected:
  explicit TopicData(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  ...
  public:
  void unsafe_arena_set_allocated_topic_data_record(
      ::ubii::topicData::TopicDataRecord* topic_data_record);
  ::ubii::topicData::TopicDataRecord* unsafe_arena_release_topic_data_record();
  ...
  public:
  void unsafe_arena_set_allocated_topic_data_record_list(
      ::ubii::topicData::TopicDataRecordList* topic_data_record_list);
  ::ubii::topicData::TopicDataRecordList* unsafe_arena_release_topic_data_record_list();
...
inline ::ubii::topicData::TopicDataRecord* TopicData::unsafe_arena_release_topic_data_record() {
  // @@protoc_insertion_point(field_unsafe_arena_release:ubii.topicData.TopicData.topic_data_record)
  if (_internal_has_topic_data_record()) {
    clear_has_type();
    ::ubii::topicData::TopicDataRecord* temp = type_.topic_data_record_;
    type_.topic_data_record_ = nullptr;
...
inline void TopicData::unsafe_arena_set_allocated_topic_data_record(::ubii::topicData::TopicDataRecord* topic_data_record) {
  clear_type();
  if (topic_data_record) {
    set_has_topic_data_record();
    type_.topic_data_record_ = topic_data_record;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ubii.topicData.TopicData.topic_data_record)
}
inline ::ubii::topicData::TopicDataRecord* TopicData::_internal_mutable_topic_data_record() {
  if (!_internal_has_topic_data_record()) {
    clear_type();
    set_has_topic_data_record();
    type_.topic_data_record_ = CreateMaybeMessage< ::ubii::topicData::TopicDataRecord >(GetArena());
  }
...
inline ::ubii::topicData::TopicDataRecordList* TopicData::unsafe_arena_release_topic_data_record_list() {
  // @@protoc_insertion_point(field_unsafe_arena_release:ubii.topicData.TopicData.topic_data_record_list)
  if (_internal_has_topic_data_record_list()) {
    clear_has_type();
    ::ubii::topicData::TopicDataRecordList* temp = type_.topic_data_record_list_;
    type_.topic_data_record_list_ = nullptr;
...
inline void TopicData::unsafe_arena_set_allocated_topic_data_record_list(::ubii::topicData::TopicDataRecordList* topic_data_record_list) {
  clear_type();
  if (topic_data_record_list) {
    set_has_topic_data_record_list();
    type_.topic_data_record_list_ = topic_data_record_list;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ubii.topicData.TopicData.topic_data_record_list)
}
inline ::ubii::topicData::TopicDataRecordList* TopicData::_internal_mutable_topic_data_record_list() {
  if (!_internal_has_topic_data_record_list()) {
    clear_type();
    set_has_topic_data_record_list();
    type_.topic_data_record_list_ = CreateMaybeMessage< ::ubii::topicData::TopicDataRecordList >(GetArena());
  }
...
inline ::ubii::general::Error* TopicData::unsafe_arena_release_error() {
  // @@protoc_insertion_point(field_unsafe_arena_release:ubii.topicData.TopicData.error)
  if (_internal_has_error()) {
    clear_has_type();
    ::ubii::general::Error* temp = type_.error_;
    type_.error_ = nullptr;
...
inline void TopicData::unsafe_arena_set_allocated_error(::ubii::general::Error* error) {
  clear_type();
  if (error) {
    set_has_error();
    type_.error_ = error;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ubii.topicData.TopicData.error)
}
