...
inline bool Client_State_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, Client_State* value) {
...
class Client PROTOBUF_FINAL :
 ...
 public:
  ...
  enum : int {
    ...
    kTagsFieldNumber = 4,
    kProcessingModulesFieldNumber = 6,
    kIdFieldNumber = 1,
    kNameFieldNumber = 2,
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_metadata_json(ArgT0&& arg0, ArgT... args);
  ...
  void _internal_set_metadata_json(const std::string& value);
  std::string* _internal_mutable_metadata_json();
  public:
  ...
  private:
  bool _internal_is_dedicated_processing_node() const;
...
class ClientList PROTOBUF_FINAL :
 ...
 public:
  ...
  ~ClientList() override;
  explicit constexpr ClientList(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline void Client::set_id(ArgT0&& arg0, ArgT... args) {
...
template <typename ArgT0, typename... ArgT>
PROTOBUF_ALWAYS_INLINE
inline void Client::set_name(ArgT0&& arg0, ArgT... args) {
...
template <typename ArgT0, typename... ArgT>
PROTOBUF_ALWAYS_INLINE
inline void Client::set_description(ArgT0&& arg0, ArgT... args) {
...
// repeated .ubii.processing.ProcessingModule processing_modules = 6;
inline int Client::_internal_processing_modules_size() const {
...
inline const ::ubii::processing::ProcessingModule& Client::_internal_processing_modules(int index) const {
...
inline ::ubii::processing::ProcessingModule* Client::_internal_add_processing_modules() {
...
inline bool Client::_internal_is_dedicated_processing_node() const {
...
inline bool Client::is_dedicated_processing_node() const {
  ...
  return _internal_is_dedicated_processing_node();
}
inline void Client::_internal_set_is_dedicated_processing_node(bool value) {
  
  is_dedicated_processing_node_ = value;
}
inline void Client::set_is_dedicated_processing_node(bool value) {
  _internal_set_is_dedicated_processing_node(value);
...
template <typename ArgT0, typename... ArgT>
PROTOBUF_ALWAYS_INLINE
inline void Client::set_host_ip(ArgT0&& arg0, ArgT... args) {
 
 host_ip_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArena());
...
inline const std::string& Client::_internal_host_ip() const {
  return host_ip_.Get();
}
inline void Client::_internal_set_host_ip(const std::string& value) {
  
  host_ip_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline std::string* Client::_internal_mutable_host_ip() {
...
template <typename ArgT0, typename... ArgT>
PROTOBUF_ALWAYS_INLINE
inline void Client::set_metadata_json(ArgT0&& arg0, ArgT... args) {
 
 metadata_json_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArena());
...
inline std::string* Client::mutable_metadata_json() {
  ...
  return _internal_mutable_metadata_json();
}
inline const std::string& Client::_internal_metadata_json() const {
  return metadata_json_.Get();
}
inline void Client::_internal_set_metadata_json(const std::string& value) {
  
  metadata_json_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline std::string* Client::_internal_mutable_metadata_json() {
  
  return metadata_json_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* Client::release_metadata_json() {
  // @@protoc_insertion_point(field_release:ubii.clients.Client.metadata_json)
  return metadata_json_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void Client::set_allocated_metadata_json(std::string* metadata_json) {
  ...
  metadata_json_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), metadata_json,
      GetArena());
