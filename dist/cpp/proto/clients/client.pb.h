...
inline std::string* Client::release_host_ip() {
  ...
  return host_ip_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
...
inline void Client::set_metadata_json(const std::string& value) {
  _internal_set_metadata_json(value);
...
inline void Client::_internal_set_metadata_json(const std::string& value) {
  ...
  metadata_json_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
...
inline void Client::set_metadata_json(const char* value) {
  ...
  metadata_json_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
...
inline void Client::set_metadata_json(const char* value, size_t size) {
  ...
  metadata_json_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
...
inline std::string* Client::_internal_mutable_metadata_json() {
  ...
  return metadata_json_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* Client::release_metadata_json() {
  // @@protoc_insertion_point(field_release:ubii.clients.Client.metadata_json)
  
  return metadata_json_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void Client::set_allocated_metadata_json(std::string* metadata_json) {
  ...
  metadata_json_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), metadata_json);
...
inline float Client::_internal_latency() const {
  return latency_;
}
...
inline void Client::_internal_set_latency(float value) {
