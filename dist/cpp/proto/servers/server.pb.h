...
class Server :
 ...
 public:
  ...
  enum : int {
    ...
    kExternalAddressServiceZmqFieldNumber = 10,
    kExternalAddressServiceHttpJsonFieldNumber = 11,
    kExternalAddressServiceHttpBinaryFieldNumber = 12,
    kExternalAddressTopicDataZmqFieldNumber = 13,
    kExternalAddressTopicDataWsFieldNumber = 14,
  };
  // string id = 1;
  void clear_id();
  ...
  private:
  const std::string& _internal_external_address_service_zmq() const;
  void _internal_set_external_address_service_zmq(const std::string& value);
  std::string* _internal_mutable_external_address_service_zmq();
  public:
  ...
  private:
  const std::string& _internal_external_address_service_http_json() const;
  void _internal_set_external_address_service_http_json(const std::string& value);
  std::string* _internal_mutable_external_address_service_http_json();
  public:
  ...
  private:
  const std::string& _internal_external_address_service_http_binary() const;
  void _internal_set_external_address_service_http_binary(const std::string& value);
  std::string* _internal_mutable_external_address_service_http_binary();
  public:
  ...
  private:
  const std::string& _internal_external_address_topic_data_zmq() const;
  void _internal_set_external_address_topic_data_zmq(const std::string& value);
  std::string* _internal_mutable_external_address_topic_data_zmq();
  public:
  ...
  private:
  const std::string& _internal_external_address_topic_data_ws() const;
  void _internal_set_external_address_topic_data_ws(const std::string& value);
  std::string* _internal_mutable_external_address_topic_data_ws();
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr external_address_service_zmq_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr external_address_service_http_json_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr external_address_service_http_binary_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr external_address_topic_data_zmq_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr external_address_topic_data_ws_;
...
inline void Server::clear_external_address_service_zmq() {
  external_address_service_zmq_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& Server::external_address_service_zmq() const {
  ...
  return _internal_external_address_service_zmq();
}
inline void Server::set_external_address_service_zmq(const std::string& value) {
  _internal_set_external_address_service_zmq(value);
...
inline std::string* Server::mutable_external_address_service_zmq() {
  ...
  return _internal_mutable_external_address_service_zmq();
}
inline const std::string& Server::_internal_external_address_service_zmq() const {
  return external_address_service_zmq_.GetNoArena();
}
inline void Server::_internal_set_external_address_service_zmq(const std::string& value) {
  
  external_address_service_zmq_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
...
inline void Server::set_external_address_service_zmq(const char* value) {
  ...
  external_address_service_zmq_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
...
inline void Server::set_external_address_service_zmq(const char* value, size_t size) {
  ...
  external_address_service_zmq_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:ubii.servers.Server.external_address_service_zmq)
}
inline std::string* Server::_internal_mutable_external_address_service_zmq() {
  
  return external_address_service_zmq_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* Server::release_external_address_service_zmq() {
  ...
  return external_address_service_zmq_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void Server::set_allocated_external_address_service_zmq(std::string* external_address_service_zmq) {
  if (external_address_service_zmq != nullptr) {
    
  } else {
    
  }
  external_address_service_zmq_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), external_address_service_zmq);
...
inline void Server::clear_external_address_service_http_json() {
  external_address_service_http_json_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& Server::external_address_service_http_json() const {
  ...
  return _internal_external_address_service_http_json();
}
inline void Server::set_external_address_service_http_json(const std::string& value) {
  _internal_set_external_address_service_http_json(value);
...
inline std::string* Server::mutable_external_address_service_http_json() {
  ...
  return _internal_mutable_external_address_service_http_json();
}
inline const std::string& Server::_internal_external_address_service_http_json() const {
  return external_address_service_http_json_.GetNoArena();
}
inline void Server::_internal_set_external_address_service_http_json(const std::string& value) {
  
  external_address_service_http_json_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
...
inline void Server::set_external_address_service_http_json(const char* value) {
  ...
  external_address_service_http_json_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
...
inline void Server::set_external_address_service_http_json(const char* value, size_t size) {
  ...
  external_address_service_http_json_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:ubii.servers.Server.external_address_service_http_json)
}
inline std::string* Server::_internal_mutable_external_address_service_http_json() {
  
  return external_address_service_http_json_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* Server::release_external_address_service_http_json() {
  ...
  return external_address_service_http_json_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void Server::set_allocated_external_address_service_http_json(std::string* external_address_service_http_json) {
  if (external_address_service_http_json != nullptr) {
    
  } else {
    
  }
  external_address_service_http_json_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), external_address_service_http_json);
...
inline void Server::clear_external_address_service_http_binary() {
  external_address_service_http_binary_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& Server::external_address_service_http_binary() const {
  ...
  return _internal_external_address_service_http_binary();
}
inline void Server::set_external_address_service_http_binary(const std::string& value) {
  _internal_set_external_address_service_http_binary(value);
...
inline std::string* Server::mutable_external_address_service_http_binary() {
  ...
  return _internal_mutable_external_address_service_http_binary();
}
inline const std::string& Server::_internal_external_address_service_http_binary() const {
  return external_address_service_http_binary_.GetNoArena();
}
inline void Server::_internal_set_external_address_service_http_binary(const std::string& value) {
  
  external_address_service_http_binary_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
...
inline void Server::set_external_address_service_http_binary(const char* value) {
  ...
  external_address_service_http_binary_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
...
inline void Server::set_external_address_service_http_binary(const char* value, size_t size) {
  ...
  external_address_service_http_binary_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:ubii.servers.Server.external_address_service_http_binary)
}
inline std::string* Server::_internal_mutable_external_address_service_http_binary() {
  
  return external_address_service_http_binary_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* Server::release_external_address_service_http_binary() {
  ...
  return external_address_service_http_binary_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void Server::set_allocated_external_address_service_http_binary(std::string* external_address_service_http_binary) {
  if (external_address_service_http_binary != nullptr) {
    
  } else {
    
  }
  external_address_service_http_binary_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), external_address_service_http_binary);
...
inline void Server::clear_external_address_topic_data_zmq() {
  external_address_topic_data_zmq_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& Server::external_address_topic_data_zmq() const {
  ...
  return _internal_external_address_topic_data_zmq();
}
inline void Server::set_external_address_topic_data_zmq(const std::string& value) {
  _internal_set_external_address_topic_data_zmq(value);
...
inline std::string* Server::mutable_external_address_topic_data_zmq() {
  ...
  return _internal_mutable_external_address_topic_data_zmq();
}
inline const std::string& Server::_internal_external_address_topic_data_zmq() const {
  return external_address_topic_data_zmq_.GetNoArena();
}
inline void Server::_internal_set_external_address_topic_data_zmq(const std::string& value) {
  
  external_address_topic_data_zmq_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
...
inline void Server::set_external_address_topic_data_zmq(const char* value) {
  ...
  external_address_topic_data_zmq_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
...
inline void Server::set_external_address_topic_data_zmq(const char* value, size_t size) {
  ...
  external_address_topic_data_zmq_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:ubii.servers.Server.external_address_topic_data_zmq)
}
inline std::string* Server::_internal_mutable_external_address_topic_data_zmq() {
  
  return external_address_topic_data_zmq_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* Server::release_external_address_topic_data_zmq() {
  ...
  return external_address_topic_data_zmq_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void Server::set_allocated_external_address_topic_data_zmq(std::string* external_address_topic_data_zmq) {
  if (external_address_topic_data_zmq != nullptr) {
    
  } else {
    
  }
  external_address_topic_data_zmq_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), external_address_topic_data_zmq);
...
inline void Server::clear_external_address_topic_data_ws() {
  external_address_topic_data_ws_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& Server::external_address_topic_data_ws() const {
  ...
  return _internal_external_address_topic_data_ws();
}
inline void Server::set_external_address_topic_data_ws(const std::string& value) {
  _internal_set_external_address_topic_data_ws(value);
...
inline std::string* Server::mutable_external_address_topic_data_ws() {
  ...
  return _internal_mutable_external_address_topic_data_ws();
}
inline const std::string& Server::_internal_external_address_topic_data_ws() const {
  return external_address_topic_data_ws_.GetNoArena();
}
inline void Server::_internal_set_external_address_topic_data_ws(const std::string& value) {
  
  external_address_topic_data_ws_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
...
inline void Server::set_external_address_topic_data_ws(const char* value) {
  ...
  external_address_topic_data_ws_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
...
inline void Server::set_external_address_topic_data_ws(const char* value, size_t size) {
  ...
  external_address_topic_data_ws_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:ubii.servers.Server.external_address_topic_data_ws)
}
inline std::string* Server::_internal_mutable_external_address_topic_data_ws() {
  
  return external_address_topic_data_ws_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* Server::release_external_address_topic_data_ws() {
  ...
  return external_address_topic_data_ws_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void Server::set_allocated_external_address_topic_data_ws(std::string* external_address_topic_data_ws) {
  if (external_address_topic_data_ws != nullptr) {
    
  } else {
    
  }
  external_address_topic_data_ws_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), external_address_topic_data_ws);
