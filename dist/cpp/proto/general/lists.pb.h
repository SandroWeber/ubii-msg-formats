...
#ifndef PROTOBUF_INCLUDED_proto_2fgeneral_2flists_2eproto
#define PROTOBUF_INCLUDED_proto_2fgeneral_2flists_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_proto_2fgeneral_2flists_2eproto 
...
namespace google {
namespace protobuf {
template<> ::ubii::general::BoolList* Arena::CreateMaybeMessage<::ubii::general::BoolList>(Arena*);
template<> ::ubii::general::DoubleList* Arena::CreateMaybeMessage<::ubii::general::DoubleList>(Arena*);
template<> ::ubii::general::FloatList* Arena::CreateMaybeMessage<::ubii::general::FloatList>(Arena*);
template<> ::ubii::general::StringList* Arena::CreateMaybeMessage<::ubii::general::StringList>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace ubii {
namespace general {
...
class StringList : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ubii.general.StringList) */ {
 public:
  StringList();
  virtual ~StringList();
 ...
 private:
  ...
  friend struct ::protobuf_proto_2fgeneral_2flists_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class DoubleList : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ubii.general.DoubleList) */ {
 public:
  DoubleList();
  virtual ~DoubleList();
...
class FloatList : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ubii.general.FloatList) */ {
 public:
  FloatList();
  virtual ~FloatList();
...
class BoolList : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ubii.general.BoolList) */ {
 public:
  BoolList();
  virtual ~BoolList();
...
inline const ::std::string& StringList::elements(int index) const {
  // @@protoc_insertion_point(field_get:ubii.general.StringList.elements)
  return elements_.Get(index);
}
inline ::std::string* StringList::mutable_elements(int index) {
  // @@protoc_insertion_point(field_mutable:ubii.general.StringList.elements)
  return elements_.Mutable(index);
}
inline void StringList::set_elements(int index, const ::std::string& value) {
  // @@protoc_insertion_point(field_set:ubii.general.StringList.elements)
...
inline void StringList::set_elements(int index, const char* value) {
  ...
  elements_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:ubii.general.StringList.elements)
}
inline void StringList::set_elements(int index, const char* value, size_t size) {
  elements_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:ubii.general.StringList.elements)
}
inline ::std::string* StringList::add_elements() {
  // @@protoc_insertion_point(field_add_mutable:ubii.general.StringList.elements)
  return elements_.Add();
}
inline void StringList::add_elements(const ::std::string& value) {
  elements_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:ubii.general.StringList.elements)
}
#if LANG_CXX11
...
inline void StringList::add_elements(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  elements_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:ubii.general.StringList.elements)
}
inline void StringList::add_elements(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_add_pointer:ubii.general.StringList.elements)
}
inline const ::google::protobuf::RepeatedPtrField< ::std::string>&
StringList::elements() const {
  // @@protoc_insertion_point(field_list:ubii.general.StringList.elements)
  return elements_;
}
inline ::google::protobuf::RepeatedPtrField< ::std::string>*
StringList::mutable_elements() {
  // @@protoc_insertion_point(field_mutable_list:ubii.general.StringList.elements)
  return &elements_;
}
...
inline double DoubleList::elements(int index) const {
  // @@protoc_insertion_point(field_get:ubii.general.DoubleList.elements)
  return elements_.Get(index);
}
inline void DoubleList::set_elements(int index, double value) {
  elements_.Set(index, value);
  // @@protoc_insertion_point(field_set:ubii.general.DoubleList.elements)
}
inline void DoubleList::add_elements(double value) {
  elements_.Add(value);
  // @@protoc_insertion_point(field_add:ubii.general.DoubleList.elements)
}
inline const ::google::protobuf::RepeatedField< double >&
DoubleList::elements() const {
  // @@protoc_insertion_point(field_list:ubii.general.DoubleList.elements)
  return elements_;
}
inline ::google::protobuf::RepeatedField< double >*
DoubleList::mutable_elements() {
  // @@protoc_insertion_point(field_mutable_list:ubii.general.DoubleList.elements)
  return &elements_;
}
...
inline float FloatList::elements(int index) const {
  // @@protoc_insertion_point(field_get:ubii.general.FloatList.elements)
  return elements_.Get(index);
}
inline void FloatList::set_elements(int index, float value) {
  elements_.Set(index, value);
  // @@protoc_insertion_point(field_set:ubii.general.FloatList.elements)
}
inline void FloatList::add_elements(float value) {
  elements_.Add(value);
  // @@protoc_insertion_point(field_add:ubii.general.FloatList.elements)
}
inline const ::google::protobuf::RepeatedField< float >&
FloatList::elements() const {
  // @@protoc_insertion_point(field_list:ubii.general.FloatList.elements)
  return elements_;
}
inline ::google::protobuf::RepeatedField< float >*
FloatList::mutable_elements() {
  // @@protoc_insertion_point(field_mutable_list:ubii.general.FloatList.elements)
  return &elements_;
}
...
inline bool BoolList::elements(int index) const {
  // @@protoc_insertion_point(field_get:ubii.general.BoolList.elements)
  return elements_.Get(index);
}
inline void BoolList::set_elements(int index, bool value) {
  elements_.Set(index, value);
  // @@protoc_insertion_point(field_set:ubii.general.BoolList.elements)
}
inline void BoolList::add_elements(bool value) {
  elements_.Add(value);
  // @@protoc_insertion_point(field_add:ubii.general.BoolList.elements)
}
inline const ::google::protobuf::RepeatedField< bool >&
BoolList::elements() const {
  // @@protoc_insertion_point(field_list:ubii.general.BoolList.elements)
  return elements_;
}
inline ::google::protobuf::RepeatedField< bool >*
BoolList::mutable_elements() {
  // @@protoc_insertion_point(field_mutable_list:ubii.general.BoolList.elements)
  return &elements_;
}
...
#endif  // PROTOBUF_INCLUDED_proto_2fgeneral_2flists_2eproto
