...
Matrix3x2 = _reflection.GeneratedProtocolMessageType('Matrix3x2', (_message.Message,), dict(
  DESCRIPTOR = _MATRIX3X2,
  __module__ = 'proto.topicData.topicDataRecord.dataStructure.matrix3x2_pb2'
