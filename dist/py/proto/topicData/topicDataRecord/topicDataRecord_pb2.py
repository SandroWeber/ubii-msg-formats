...
_TOPICDATARECORD = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='interaction', full_name='ubii.topicData.TopicDataRecord.interaction', index=32,
...
_TOPICDATARECORD.fields_by_name['interaction'].message_type = proto_dot_interactions_dot_interaction__pb2._INTERACTION
...
_TOPICDATARECORD.oneofs_by_name['type'].fields.append(
  _TOPICDATARECORD.fields_by_name['interaction'])
_TOPICDATARECORD.fields_by_name['interaction'].containing_oneof = _TOPICDATARECORD.oneofs_by_name['type']
