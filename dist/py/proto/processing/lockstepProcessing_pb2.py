...
LockstepProcessingRequest = _reflection.GeneratedProtocolMessageType('LockstepProcessingRequest', (_message.Message,), dict(
...
LockstepProcessingReply = _reflection.GeneratedProtocolMessageType('LockstepProcessingReply', (_message.Message,), dict(
