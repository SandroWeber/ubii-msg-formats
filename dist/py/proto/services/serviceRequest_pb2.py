...
_SERVICEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='interaction_specs', full_name='ubii.services.ServiceRequest.interaction_specs', index=6,
...
_SERVICEREQUEST.fields_by_name['interaction_specs'].message_type = proto_dot_interactions_dot_interaction__pb2._INTERACTION
...
_SERVICEREQUEST.oneofs_by_name['type'].fields.append(
  _SERVICEREQUEST.fields_by_name['interaction_specs'])
_SERVICEREQUEST.fields_by_name['interaction_specs'].containing_oneof = _SERVICEREQUEST.oneofs_by_name['type']
_SERVICEREQUEST.oneofs_by_name['type'].fields.append(
