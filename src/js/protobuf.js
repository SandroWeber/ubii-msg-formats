...
$root.ubii = (function() {
    ...
    ubii.service = (function() {
        ...
        service.reply = (function() {
            ...
            reply.ClientSpecification = (function() {
                 ...
                 * @property {string|null} [targetHost] ClientSpecification targetHost
                 * @property {string|null} [targetPort] ClientSpecification targetPort
                 */
                ...
                /**
                 * ClientSpecification targetHost.
                 * @member {string} targetHost
                 * @memberof ubii.service.reply.ClientSpecification
                 * @instance
                 */
                ClientSpecification.prototype.targetHost = "";

                /**
                 * ClientSpecification targetPort.
                 * @member {string} targetPort
                 * @memberof ubii.service.reply.ClientSpecification
                 * @instance
                 */
                ClientSpecification.prototype.targetPort = "";
                ...
                ClientSpecification.encode = function encode(message, writer) {
                    ...
                    if (message.targetHost != null && message.hasOwnProperty("targetHost"))
                        writer.uint32(/* id 4, wireType 2 =*/34).string(message.targetHost);
                    if (message.targetPort != null && message.hasOwnProperty("targetPort"))
                        writer.uint32(/* id 5, wireType 2 =*/42).string(message.targetPort);
                    return writer;
                };
                ...
                ClientSpecification.decode = function decode(reader, length) {
                    ...
                    while (reader.pos < end) {
                        ...
                        case 4:
                            ...
                            break;
                        case 5:
                            message.targetPort = reader.string();
                            break;
                        default:
                            reader.skipType(tag & 7);
                            break;
                ...
                ClientSpecification.verify = function verify(message) {
                    ...
                    if (message.targetHost != null && message.hasOwnProperty("targetHost"))
                        if (!$util.isString(message.targetHost))
                            return "targetHost: string expected";
                    if (message.targetPort != null && message.hasOwnProperty("targetPort"))
                        if (!$util.isString(message.targetPort))
                            return "targetPort: string expected";
                    return null;
                };
                ...
                ClientSpecification.fromObject = function fromObject(object) {
                    ...
                    if (object.targetHost != null)
                        message.targetHost = String(object.targetHost);
                    if (object.targetPort != null)
                        message.targetPort = String(object.targetPort);
                    return message;
                };
                ...
                ClientSpecification.toObject = function toObject(message, options) {
                    ...
                    if (message.targetHost != null && message.hasOwnProperty("targetHost"))
                        object.targetHost = message.targetHost;
                    if (message.targetPort != null && message.hasOwnProperty("targetPort"))
        ...
        service.request = (function() {
            ...
            request.DeviceRegistration = (function() {
                 ...
                 * @instance
                 */
                DeviceRegistration.prototype.deviceType = 1;
                ...
                DeviceRegistration.toObject = function toObject(message, options) {
                    ...
                    if (options.defaults) {
                        object.name = "";
                        object.deviceType = options.enums === String ? "PARTICIPANT" : 1;
                        object.correspondingClientIdentifier = "";
                    }
                    if (message.name != null && message.hasOwnProperty("name"))
                        object.name = message.name;
            ...
            request.Subscribtion = (function() {

                /**
                 * Properties of a Subscribtion.
                 * @memberof ubii.service.request
                 * @interface ISubscribtion
                 * @property {string|null} [deviceIdentifier] Subscribtion deviceIdentifier
                 * @property {Array.<string>|null} [subscribeTopics] Subscribtion subscribeTopics
                 * @property {Array.<string>|null} [unsubscribeTopics] Subscribtion unsubscribeTopics
                 */

                /**
                 * Constructs a new Subscribtion.
                 * @memberof ubii.service.request
                 * @classdesc Represents a Subscribtion.
                 * @implements ISubscribtion
                 * @constructor
                 * @param {ubii.service.request.ISubscribtion=} [properties] Properties to set
                 */
                function Subscribtion(properties) {
                ...
                /**
                 * Subscribtion deviceIdentifier.
                 * @member {string} deviceIdentifier
                 * @memberof ubii.service.request.Subscribtion
                 * @instance
                 */
                Subscribtion.prototype.deviceIdentifier = "";

                /**
                 * Subscribtion subscribeTopics.
                 * @member {Array.<string>} subscribeTopics
                 * @memberof ubii.service.request.Subscribtion
                 * @instance
                 */
                Subscribtion.prototype.subscribeTopics = $util.emptyArray;

                /**
                 * Subscribtion unsubscribeTopics.
                 * @member {Array.<string>} unsubscribeTopics
                 * @memberof ubii.service.request.Subscribtion
                 * @instance
                 */
                Subscribtion.prototype.unsubscribeTopics = $util.emptyArray;

                /**
                 * Creates a new Subscribtion instance using the specified properties.
                 * @function create
                 * @memberof ubii.service.request.Subscribtion
                 * @static
                 * @param {ubii.service.request.ISubscribtion=} [properties] Properties to set
                 * @returns {ubii.service.request.Subscribtion} Subscribtion instance
                 */
                Subscribtion.create = function create(properties) {
                    return new Subscribtion(properties);
                };

                /**
                 * Encodes the specified Subscribtion message. Does not implicitly {@link ubii.service.request.Subscribtion.verify|verify} messages.
                 * @function encode
                 * @memberof ubii.service.request.Subscribtion
                 * @static
                 * @param {ubii.service.request.ISubscribtion} message Subscribtion message or plain object to encode
                 * @param {$protobuf.Writer} [writer] Writer to encode to
                 * @returns {$protobuf.Writer} Writer
                 */
                Subscribtion.encode = function encode(message, writer) {
                    if (!writer)
                        writer = $Writer.create();
                ...
                /**
                 * Encodes the specified Subscribtion message, length delimited. Does not implicitly {@link ubii.service.request.Subscribtion.verify|verify} messages.
                 * @function encodeDelimited
                 * @memberof ubii.service.request.Subscribtion
                 * @static
                 * @param {ubii.service.request.ISubscribtion} message Subscribtion message or plain object to encode
                 ...
                 * @returns {$protobuf.Writer} Writer
                 */
                Subscribtion.encodeDelimited = function encodeDelimited(message, writer) {
                    return this.encode(message, writer).ldelim();
                };

                /**
                 * Decodes a Subscribtion message from the specified reader or buffer.
                 * @function decode
                 * @memberof ubii.service.request.Subscribtion
                 * @static
                 * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
                 * @param {number} [length] Message length if known beforehand
                 * @returns {ubii.service.request.Subscribtion} Subscribtion
                 * @throws {Error} If the payload is not a reader or valid buffer
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                Subscribtion.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ubii.service.request.Subscribtion();
                    while (reader.pos < end) {
                        var tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 1:
                ...
                /**
                 * Decodes a Subscribtion message from the specified reader or buffer, length delimited.
                 * @function decodeDelimited
                 * @memberof ubii.service.request.Subscribtion
                 * @static
                 * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                Subscribtion.decodeDelimited = function decodeDelimited(reader) {
                    if (!(reader instanceof $Reader))
                        reader = new $Reader(reader);
                    return this.decode(reader, reader.uint32());
                };
                ...
                /**
                 * Verifies a Subscribtion message.
                 * @function verify
                 * @memberof ubii.service.request.Subscribtion
                 * @static
                 * @param {Object.<string,*>} message Plain object to verify
                 * @returns {string|null} `null` if valid, otherwise the reason why it is not
                 */
                Subscribtion.verify = function verify(message) {
                    if (typeof message !== "object" || message === null)
                        return "object expected";
                    if (message.deviceIdentifier != null && message.hasOwnProperty("deviceIdentifier"))
                ...
                /**
                 * Creates a Subscribtion message from a plain object. Also converts values to their respective internal types.
                 * @function fromObject
                 * @memberof ubii.service.request.Subscribtion
                 * @static
                 * @param {Object.<string,*>} object Plain object
                 * @returns {ubii.service.request.Subscribtion} Subscribtion
                 */
                Subscribtion.fromObject = function fromObject(object) {
                    if (object instanceof $root.ubii.service.request.Subscribtion)
                        return object;
                    var message = new $root.ubii.service.request.Subscribtion();
                    ...
                    if (object.subscribeTopics) {
                        if (!Array.isArray(object.subscribeTopics))
                            throw TypeError(".ubii.service.request.Subscribtion.subscribeTopics: array expected");
                        message.subscribeTopics = [];
                    ...
                    if (object.unsubscribeTopics) {
                        if (!Array.isArray(object.unsubscribeTopics))
                            throw TypeError(".ubii.service.request.Subscribtion.unsubscribeTopics: array expected");
                        message.unsubscribeTopics = [];
                ...
                /**
                 * Creates a plain object from a Subscribtion message. Also converts values to other types if specified.
                 * @function toObject
                 * @memberof ubii.service.request.Subscribtion
                 * @static
                 * @param {ubii.service.request.Subscribtion} message Subscribtion
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
                Subscribtion.toObject = function toObject(message, options) {
                    if (!options)
                        options = {};
                    var object = {};
                ...
                /**
                 * Converts this Subscribtion to JSON.
                 * @function toJSON
                 * @memberof ubii.service.request.Subscribtion
                 * @instance
                 * @returns {Object.<string,*>} JSON object
                 */
                Subscribtion.prototype.toJSON = function toJSON() {
                    return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
                };
        ...
        service.ServiceRequest = (function() {
             ...
             * @property {ubii.service.request.ISubscribtion|null} [subscribtion] ServiceRequest subscribtion
             */
            ...
            /**
             * ServiceRequest subscribtion.
             * @member {ubii.service.request.ISubscribtion|null|undefined} subscribtion
             * @memberof ubii.service.ServiceRequest
             * @instance
             */
            ServiceRequest.prototype.subscribtion = null;
            ...
            /**
             * ServiceRequest type.
             * @member {"clientRegistration"|"deviceRegistration"|"subscribtion"|undefined} type
             * @memberof ubii.service.ServiceRequest
             * @instance
             */
            Object.defineProperty(ServiceRequest.prototype, "type", {
                get: $util.oneOfGetter($oneOfFields = ["clientRegistration", "deviceRegistration", "subscribtion"]),
                set: $util.oneOfSetter($oneOfFields)
            });
            ...
            ServiceRequest.encode = function encode(message, writer) {
                ...
                if (message.subscribtion != null && message.hasOwnProperty("subscribtion"))
                    $root.ubii.service.request.Subscribtion.encode(message.subscribtion, writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
                return writer;
            };
            ...
            ServiceRequest.decode = function decode(reader, length) {
                ...
                while (reader.pos < end) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        message.subscribtion = $root.ubii.service.request.Subscribtion.decode(reader, reader.uint32());
                        break;
                    default:
                        reader.skipType(tag & 7);
                        break;
            ...
            ServiceRequest.verify = function verify(message) {
                ...
                if (message.subscribtion != null && message.hasOwnProperty("subscribtion")) {
                    ...
                    properties.type = 1;
                    {
                        var error = $root.ubii.service.request.Subscribtion.verify(message.subscribtion);
                        if (error)
                            return "subscribtion." + error;
                    }
                }
                return null;
            };
            ...
            ServiceRequest.fromObject = function fromObject(object) {
                ...
                if (object.subscribtion != null) {
                    if (typeof object.subscribtion !== "object")
                        throw TypeError(".ubii.service.ServiceRequest.subscribtion: object expected");
                    message.subscribtion = $root.ubii.service.request.Subscribtion.fromObject(object.subscribtion);
                }
                return message;
            };
            ...
            ServiceRequest.toObject = function toObject(message, options) {
                ...
                if (message.subscribtion != null && message.hasOwnProperty("subscribtion")) {
                    object.subscribtion = $root.ubii.service.request.Subscribtion.toObject(message.subscribtion, options);
                    if (options.oneofs)
                        object.type = "subscribtion";
                }
                return object;
            };
            ...
            CauseEffectRelation.encode = function encode(message, writer) {
                ...
                if (message.causes != null && message.causes.length)
                    for (var i = 0; i < message.causes.length; ++i)
                        $root.ubii.interaction.Cause.encode(message.causes[i], writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
                if (message.effects != null && message.effects.length)
                    for (var i = 0; i < message.effects.length; ++i)
                        $root.ubii.interaction.Effect.encode(message.effects[i], writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
                return writer;
            };
    ...
    ubii.session = (function() {
        ...
        session.InteractionTopicMapping = (function() {

            /**
             * Properties of an InteractionTopicMapping.
             * @memberof ubii.session
             * @interface IInteractionTopicMapping
             * @property {string|null} [interactionIdentifier] InteractionTopicMapping interactionIdentifier
             * @property {string|null} [topic] InteractionTopicMapping topic
             * @property {ubii.session.InteractionTopicMapping.IOType|null} [ioType] InteractionTopicMapping ioType
             * @property {string|null} [internalName] InteractionTopicMapping internalName
             */

            /**
             * Constructs a new InteractionTopicMapping.
             * @memberof ubii.session
             * @classdesc Represents an InteractionTopicMapping.
             * @implements IInteractionTopicMapping
             * @constructor
             * @param {ubii.session.IInteractionTopicMapping=} [properties] Properties to set
             */
            function InteractionTopicMapping(properties) {
                if (properties)
                    for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                        if (properties[keys[i]] != null)
                            this[keys[i]] = properties[keys[i]];
            ...
            /**
             * InteractionTopicMapping interactionIdentifier.
             * @member {string} interactionIdentifier
             * @memberof ubii.session.InteractionTopicMapping
             * @instance
             */
            InteractionTopicMapping.prototype.interactionIdentifier = "";

            /**
             * InteractionTopicMapping topic.
             * @member {string} topic
             * @memberof ubii.session.InteractionTopicMapping
             * @instance
             */
            InteractionTopicMapping.prototype.topic = "";

            /**
             * InteractionTopicMapping ioType.
             * @member {ubii.session.InteractionTopicMapping.IOType} ioType
             * @memberof ubii.session.InteractionTopicMapping
             * @instance
             */
            InteractionTopicMapping.prototype.ioType = 0;

            /**
             * InteractionTopicMapping internalName.
             * @member {string} internalName
             * @memberof ubii.session.InteractionTopicMapping
             * @instance
             */
            InteractionTopicMapping.prototype.internalName = "";

            /**
             * Creates a new InteractionTopicMapping instance using the specified properties.
             * @function create
             * @memberof ubii.session.InteractionTopicMapping
             * @static
             * @param {ubii.session.IInteractionTopicMapping=} [properties] Properties to set
             * @returns {ubii.session.InteractionTopicMapping} InteractionTopicMapping instance
             */
            InteractionTopicMapping.create = function create(properties) {
                return new InteractionTopicMapping(properties);
            };

            /**
             * Encodes the specified InteractionTopicMapping message. Does not implicitly {@link ubii.session.InteractionTopicMapping.verify|verify} messages.
             * @function encode
             * @memberof ubii.session.InteractionTopicMapping
             * @static
             * @param {ubii.session.IInteractionTopicMapping} message InteractionTopicMapping message or plain object to encode
             * @param {$protobuf.Writer} [writer] Writer to encode to
             * @returns {$protobuf.Writer} Writer
             */
            InteractionTopicMapping.encode = function encode(message, writer) {
                if (!writer)
                    writer = $Writer.create();
                if (message.interactionIdentifier != null && message.hasOwnProperty("interactionIdentifier"))
                    writer.uint32(/* id 1, wireType 2 =*/10).string(message.interactionIdentifier);
                if (message.topic != null && message.hasOwnProperty("topic"))
                    writer.uint32(/* id 2, wireType 2 =*/18).string(message.topic);
                if (message.ioType != null && message.hasOwnProperty("ioType"))
                    writer.uint32(/* id 3, wireType 0 =*/24).int32(message.ioType);
                if (message.internalName != null && message.hasOwnProperty("internalName"))
                    writer.uint32(/* id 4, wireType 2 =*/34).string(message.internalName);
                return writer;
            };

            /**
             * Encodes the specified InteractionTopicMapping message, length delimited. Does not implicitly {@link ubii.session.InteractionTopicMapping.verify|verify} messages.
             * @function encodeDelimited
             * @memberof ubii.session.InteractionTopicMapping
             * @static
             * @param {ubii.session.IInteractionTopicMapping} message InteractionTopicMapping message or plain object to encode
             ...
             * @returns {$protobuf.Writer} Writer
             */
            InteractionTopicMapping.encodeDelimited = function encodeDelimited(message, writer) {
                return this.encode(message, writer).ldelim();
            };

            /**
             * Decodes an InteractionTopicMapping message from the specified reader or buffer.
             * @function decode
             * @memberof ubii.session.InteractionTopicMapping
             * @static
             * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
             * @param {number} [length] Message length if known beforehand
             * @returns {ubii.session.InteractionTopicMapping} InteractionTopicMapping
             * @throws {Error} If the payload is not a reader or valid buffer
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            InteractionTopicMapping.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ubii.session.InteractionTopicMapping();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
                        message.interactionIdentifier = reader.string();
                        break;
                    case 2:
                        message.topic = reader.string();
                        break;
            ...
            /**
             * Decodes an InteractionTopicMapping message from the specified reader or buffer, length delimited.
             * @function decodeDelimited
             * @memberof ubii.session.InteractionTopicMapping
             * @static
             * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            InteractionTopicMapping.decodeDelimited = function decodeDelimited(reader) {
                if (!(reader instanceof $Reader))
                    reader = new $Reader(reader);
                return this.decode(reader, reader.uint32());
            };
            ...
            /**
             * Verifies an InteractionTopicMapping message.
             * @function verify
             * @memberof ubii.session.InteractionTopicMapping
             * @static
             * @param {Object.<string,*>} message Plain object to verify
             * @returns {string|null} `null` if valid, otherwise the reason why it is not
             */
            InteractionTopicMapping.verify = function verify(message) {
                if (typeof message !== "object" || message === null)
                    return "object expected";
                if (message.interactionIdentifier != null && message.hasOwnProperty("interactionIdentifier"))
                    if (!$util.isString(message.interactionIdentifier))
                        return "interactionIdentifier: string expected";
                if (message.topic != null && message.hasOwnProperty("topic"))
                    if (!$util.isString(message.topic))
                        return "topic: string expected";
                if (message.ioType != null && message.hasOwnProperty("ioType"))
            ...
            /**
             * Creates an InteractionTopicMapping message from a plain object. Also converts values to their respective internal types.
             * @function fromObject
             * @memberof ubii.session.InteractionTopicMapping
             * @static
             * @param {Object.<string,*>} object Plain object
             * @returns {ubii.session.InteractionTopicMapping} InteractionTopicMapping
             */
            InteractionTopicMapping.fromObject = function fromObject(object) {
                if (object instanceof $root.ubii.session.InteractionTopicMapping)
                    return object;
                var message = new $root.ubii.session.InteractionTopicMapping();
                if (object.interactionIdentifier != null)
                    message.interactionIdentifier = String(object.interactionIdentifier);
                if (object.topic != null)
                    message.topic = String(object.topic);
            ...
            /**
             * Creates a plain object from an InteractionTopicMapping message. Also converts values to other types if specified.
             * @function toObject
             * @memberof ubii.session.InteractionTopicMapping
             * @static
             * @param {ubii.session.InteractionTopicMapping} message InteractionTopicMapping
             * @param {$protobuf.IConversionOptions} [options] Conversion options
             * @returns {Object.<string,*>} Plain object
             */
            InteractionTopicMapping.toObject = function toObject(message, options) {
                if (!options)
                    options = {};
                var object = {};
                if (options.defaults) {
                    object.interactionIdentifier = "";
                    object.topic = "";
                    object.ioType = options.enums === String ? "INPUT" : 0;
                    object.internalName = "";
                }
                if (message.interactionIdentifier != null && message.hasOwnProperty("interactionIdentifier"))
                    object.interactionIdentifier = message.interactionIdentifier;
                if (message.topic != null && message.hasOwnProperty("topic"))
                    object.topic = message.topic;
                if (message.ioType != null && message.hasOwnProperty("ioType"))
                    object.ioType = options.enums === String ? $root.ubii.session.InteractionTopicMapping.IOType[message.ioType] : message.ioType;
                if (message.internalName != null && message.hasOwnProperty("internalName"))
                    object.internalName = message.internalName;
                return object;
            };
            ...
            /**
             * Converts this InteractionTopicMapping to JSON.
             * @function toJSON
             * @memberof ubii.session.InteractionTopicMapping
             * @instance
             * @returns {Object.<string,*>} JSON object
             */
            InteractionTopicMapping.prototype.toJSON = function toJSON() {
                return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
            };

            /**
             * IOType enum.
             * @name ubii.session.InteractionTopicMapping.IOType
             * @enum {string}
             * @property {number} INPUT=0 INPUT value
             * @property {number} OUTPUT=1 OUTPUT value
             */
            InteractionTopicMapping.IOType = (function() {
                var valuesById = {}, values = Object.create(valuesById);
            ...
            return InteractionTopicMapping;
        })();
        ...
        session.Session = (function() {
             ...
             * @property {Array.<ubii.session.IInteractionTopicMapping>|null} [interactionTopicMappings] Session interactionTopicMappings
             */
            ...
            /**
             * Session interactionTopicMappings.
             * @member {Array.<ubii.session.IInteractionTopicMapping>} interactionTopicMappings
             * @memberof ubii.session.Session
             * @instance
             */
            Session.prototype.interactionTopicMappings = $util.emptyArray;
            ...
            Session.encode = function encode(message, writer) {
                ...
                if (message.interactionTopicMappings != null && message.interactionTopicMappings.length)
                    for (var i = 0; i < message.interactionTopicMappings.length; ++i)
                        $root.ubii.session.InteractionTopicMapping.encode(message.interactionTopicMappings[i], writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
                return writer;
            };
            ...
            Session.decode = function decode(reader, length) {
                ...
                while (reader.pos < end) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        if (!(message.interactionTopicMappings && message.interactionTopicMappings.length))
                            message.interactionTopicMappings = [];
                        message.interactionTopicMappings.push($root.ubii.session.InteractionTopicMapping.decode(reader, reader.uint32()));
                        break;
                    default:
                        reader.skipType(tag & 7);
                        break;
            ...
            Session.verify = function verify(message) {
                ...
                if (message.interactionTopicMappings != null && message.hasOwnProperty("interactionTopicMappings")) {
                    if (!Array.isArray(message.interactionTopicMappings))
                        return "interactionTopicMappings: array expected";
                    for (var i = 0; i < message.interactionTopicMappings.length; ++i) {
                        var error = $root.ubii.session.InteractionTopicMapping.verify(message.interactionTopicMappings[i]);
                        if (error)
                            return "interactionTopicMappings." + error;
                    }
                }
                return null;
            };
            ...
            Session.fromObject = function fromObject(object) {
                ...
                if (object.interactionTopicMappings) {
                    if (!Array.isArray(object.interactionTopicMappings))
                        throw TypeError(".ubii.session.Session.interactionTopicMappings: array expected");
                    message.interactionTopicMappings = [];
                    for (var i = 0; i < object.interactionTopicMappings.length; ++i) {
                        if (typeof object.interactionTopicMappings[i] !== "object")
                            throw TypeError(".ubii.session.Session.interactionTopicMappings: object expected");
                        message.interactionTopicMappings[i] = $root.ubii.session.InteractionTopicMapping.fromObject(object.interactionTopicMappings[i]);
                    }
                }
                return message;
            };
            ...
            Session.toObject = function toObject(message, options) {
                ...
                if (options.arrays || options.defaults) {
                    object.interactions = [];
                    object.interactionTopicMappings = [];
                }
                if (options.defaults)
                    object.name = "";
                if (message.name != null && message.hasOwnProperty("name"))
                ...
                if (message.interactionTopicMappings && message.interactionTopicMappings.length) {
                    object.interactionTopicMappings = [];
                    for (var j = 0; j < message.interactionTopicMappings.length; ++j)
                        object.interactionTopicMappings[j] = $root.ubii.session.InteractionTopicMapping.toObject(message.interactionTopicMappings[j], options);
                }
                return object;
            };
