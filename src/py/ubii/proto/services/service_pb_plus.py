...
class Service(proto.message.Message):
    ...
    request_message_format = proto.Field(proto.STRING, number=2)
    response_message_format = proto.Field(proto.STRING, number=3)
...
class ServiceList(proto.message.Message):
    elements = proto.RepeatedField(Service, number=1)
