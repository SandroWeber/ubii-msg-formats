...
# source: ubii/proto/processing/processingModule.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='ubii/proto/processing/processingModule.proto',
  package='ubii.proto.processing',
  syntax='proto3',
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n,ubii/proto/processing/processingModule.proto\x12\x15ubii.proto.processing\"\x86\x03\n\x0eProcessingMode\x12\x44\n\tfrequency\x18\x01 \x01(\x0b\x32/.ubii.proto.processing.ProcessingMode.FrequencyH\x00\x12\x42\n\x08lockstep\x18\x02 \x01(\x0b\x32..ubii.proto.processing.ProcessingMode.LockstepH\x00\x12P\n\x10trigger_on_input\x18\x03 \x01(\x0b\x32\x34.ubii.proto.processing.ProcessingMode.TriggerOnInputH\x00\x1a\x1a\n\tFrequency\x12\r\n\x05hertz\x18\x01 \x01(\x05\x1a,\n\x08Lockstep\x12 \n\x18process_request_endpoint\x18\x01 \x01(\t\x1a\x46\n\x0eTriggerOnInput\x12\x14\n\x0cmin_delay_ms\x18\x01 \x01(\x05\x12\x1e\n\x16\x61ll_inputs_need_update\x18\x02 \x01(\x08\x42\x06\n\x04mode\"9\n\x08ModuleIO\x12\x15\n\rinternal_name\x18\x01 \x01(\t\x12\x16\n\x0emessage_format\x18\x02 \x01(\t\"\xba\x05\n\x10ProcessingModule\x12\n\n\x02id\x18\x01 \x01(\t\x12\x0c\n\x04name\x18\x02 \x01(\t\x12\x0f\n\x07\x61uthors\x18\x03 \x03(\t\x12\x0c\n\x04tags\x18\x04 \x03(\t\x12\x13\n\x0b\x64\x65scription\x18\x05 \x01(\t\x12\x0f\n\x07node_id\x18\x06 \x01(\t\x12\x12\n\nsession_id\x18\x07 \x01(\t\x12>\n\x06status\x18\x08 \x01(\x0e\x32..ubii.proto.processing.ProcessingModule.Status\x12>\n\x0fprocessing_mode\x18\t \x01(\x0b\x32%.ubii.proto.processing.ProcessingMode\x12/\n\x06inputs\x18\n \x03(\x0b\x32\x1f.ubii.proto.processing.ModuleIO\x12\x30\n\x07outputs\x18\x0b \x03(\x0b\x32\x1f.ubii.proto.processing.ModuleIO\x12\x42\n\x08language\x18\x0c \x01(\x0e\x32\x30.ubii.proto.processing.ProcessingModule.Language\x12!\n\x19on_processing_stringified\x18\r \x01(\t\x12\x1e\n\x16on_created_stringified\x18\x0e \x01(\t\x12\x1d\n\x15on_halted_stringified\x18\x0f \x01(\t\x12 \n\x18on_destroyed_stringified\x18\x10 \x01(\t\"Q\n\x06Status\x12\x0f\n\x0bINITIALIZED\x10\x00\x12\x0b\n\x07\x43REATED\x10\x01\x12\x0e\n\nPROCESSING\x10\x02\x12\n\n\x06HALTED\x10\x03\x12\r\n\tDESTROYED\x10\x04\"5\n\x08Language\x12\x07\n\x03\x43PP\x10\x00\x12\x06\n\x02PY\x10\x01\x12\x06\n\x02JS\x10\x02\x12\x06\n\x02\x43S\x10\x03\x12\x08\n\x04JAVA\x10\x04\"Q\n\x14ProcessingModuleList\x12\x39\n\x08\x65lements\x18\x01 \x03(\x0b\x32\'.ubii.proto.processing.ProcessingModuleb\x06proto3'
)
...
_PROCESSINGMODULE_STATUS = _descriptor.EnumDescriptor(
  name='Status',
  full_name='ubii.proto.processing.ProcessingModule.Status',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_PROCESSINGMODULE_LANGUAGE = _descriptor.EnumDescriptor(
  name='Language',
  full_name='ubii.proto.processing.ProcessingModule.Language',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_PROCESSINGMODE_FREQUENCY = _descriptor.Descriptor(
  name='Frequency',
  full_name='ubii.proto.processing.ProcessingMode.Frequency',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='hertz', full_name='ubii.proto.processing.ProcessingMode.Frequency.hertz', index=0,
...
_PROCESSINGMODE_LOCKSTEP = _descriptor.Descriptor(
  name='Lockstep',
  full_name='ubii.proto.processing.ProcessingMode.Lockstep',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='process_request_endpoint', full_name='ubii.proto.processing.ProcessingMode.Lockstep.process_request_endpoint', index=0,
...
_PROCESSINGMODE_TRIGGERONINPUT = _descriptor.Descriptor(
  name='TriggerOnInput',
  full_name='ubii.proto.processing.ProcessingMode.TriggerOnInput',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='min_delay_ms', full_name='ubii.proto.processing.ProcessingMode.TriggerOnInput.min_delay_ms', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='all_inputs_need_update', full_name='ubii.proto.processing.ProcessingMode.TriggerOnInput.all_inputs_need_update', index=1,
...
_PROCESSINGMODE = _descriptor.Descriptor(
  name='ProcessingMode',
  full_name='ubii.proto.processing.ProcessingMode',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='frequency', full_name='ubii.proto.processing.ProcessingMode.frequency', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='lockstep', full_name='ubii.proto.processing.ProcessingMode.lockstep', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='trigger_on_input', full_name='ubii.proto.processing.ProcessingMode.trigger_on_input', index=2,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='mode', full_name='ubii.proto.processing.ProcessingMode.mode',
...
_MODULEIO = _descriptor.Descriptor(
  name='ModuleIO',
  full_name='ubii.proto.processing.ModuleIO',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='internal_name', full_name='ubii.proto.processing.ModuleIO.internal_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='message_format', full_name='ubii.proto.processing.ModuleIO.message_format', index=1,
...
_PROCESSINGMODULE = _descriptor.Descriptor(
  ...
  full_name='ubii.proto.processing.ProcessingModule',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='ubii.proto.processing.ProcessingModule.id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='name', full_name='ubii.proto.processing.ProcessingModule.name', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='authors', full_name='ubii.proto.processing.ProcessingModule.authors', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='tags', full_name='ubii.proto.processing.ProcessingModule.tags', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='description', full_name='ubii.proto.processing.ProcessingModule.description', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='node_id', full_name='ubii.proto.processing.ProcessingModule.node_id', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='session_id', full_name='ubii.proto.processing.ProcessingModule.session_id', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='status', full_name='ubii.proto.processing.ProcessingModule.status', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='processing_mode', full_name='ubii.proto.processing.ProcessingModule.processing_mode', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='inputs', full_name='ubii.proto.processing.ProcessingModule.inputs', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='outputs', full_name='ubii.proto.processing.ProcessingModule.outputs', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='language', full_name='ubii.proto.processing.ProcessingModule.language', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='on_processing_stringified', full_name='ubii.proto.processing.ProcessingModule.on_processing_stringified', index=12,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='on_created_stringified', full_name='ubii.proto.processing.ProcessingModule.on_created_stringified', index=13,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='on_halted_stringified', full_name='ubii.proto.processing.ProcessingModule.on_halted_stringified', index=14,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='on_destroyed_stringified', full_name='ubii.proto.processing.ProcessingModule.on_destroyed_stringified', index=15,
...
_PROCESSINGMODULELIST = _descriptor.Descriptor(
  ...
  full_name='ubii.proto.processing.ProcessingModuleList',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='elements', full_name='ubii.proto.processing.ProcessingModuleList.elements', index=0,
...
ProcessingMode = _reflection.GeneratedProtocolMessageType('ProcessingMode', (_message.Message,), {
  ...
  'Frequency' : _reflection.GeneratedProtocolMessageType('Frequency', (_message.Message,), {
    ...
    '__module__' : 'ubii.proto.processing.processingModule_pb2'
    # @@protoc_insertion_point(class_scope:ubii.proto.processing.ProcessingMode.Frequency)
    })
  ,
  ...
  'Lockstep' : _reflection.GeneratedProtocolMessageType('Lockstep', (_message.Message,), {
    ...
    '__module__' : 'ubii.proto.processing.processingModule_pb2'
    # @@protoc_insertion_point(class_scope:ubii.proto.processing.ProcessingMode.Lockstep)
    })
  ,
  ...
  'TriggerOnInput' : _reflection.GeneratedProtocolMessageType('TriggerOnInput', (_message.Message,), {
    ...
    '__module__' : 'ubii.proto.processing.processingModule_pb2'
    # @@protoc_insertion_point(class_scope:ubii.proto.processing.ProcessingMode.TriggerOnInput)
    })
  ,
  'DESCRIPTOR' : _PROCESSINGMODE,
  '__module__' : 'ubii.proto.processing.processingModule_pb2'
  # @@protoc_insertion_point(class_scope:ubii.proto.processing.ProcessingMode)
  })
...
ModuleIO = _reflection.GeneratedProtocolMessageType('ModuleIO', (_message.Message,), {
  ...
  '__module__' : 'ubii.proto.processing.processingModule_pb2'
  # @@protoc_insertion_point(class_scope:ubii.proto.processing.ModuleIO)
  })
...
ProcessingModule = _reflection.GeneratedProtocolMessageType('ProcessingModule', (_message.Message,), {
  ...
  '__module__' : 'ubii.proto.processing.processingModule_pb2'
  # @@protoc_insertion_point(class_scope:ubii.proto.processing.ProcessingModule)
  })
...
ProcessingModuleList = _reflection.GeneratedProtocolMessageType('ProcessingModuleList', (_message.Message,), {
  ...
  '__module__' : 'ubii.proto.processing.processingModule_pb2'
  # @@protoc_insertion_point(class_scope:ubii.proto.processing.ProcessingModuleList)
  })
